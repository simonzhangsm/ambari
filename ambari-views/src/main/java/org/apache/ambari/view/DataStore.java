...
public interface DataStore {
	...
	/**
	 * Save the given entity to persistent storage. The entity must be declared as an <entity> in the <persistence> element of the view.xml.
	 * 
	 ...
	 * @param <T> the entity type
	 * @return all of the entities for the given where clause; empty collection if no entities can be found
