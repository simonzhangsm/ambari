...
POLL_INTERVAL_SEC = 1
DEBUG = False
PYTHON_ENV = "/usr/bin/env PYTHONPATH=$PYTHONPATH:/tmp "
PYTHON_VER = str(sys.version_info[0]) + "." + str(sys.version_info[1])
...
class Bootstrap(threading.Thread):
  ...
  COMMON_FUNCTIONS = "/usr/lib/python" + PYTHON_VER + "/site-packages/common_functions"
