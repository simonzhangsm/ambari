...
public class ServiceComponentHostOpInProgressEvent extends ServiceComponentHostEvent {
	
	public ServiceComponentHostOpInProgressEvent(String serviceComponentName, String hostName, long opTimestamp) {
		super(ServiceComponentHostEventType.HOST_SVCCOMP_OP_IN_PROGRESS, serviceComponentName, hostName, opTimestamp);
