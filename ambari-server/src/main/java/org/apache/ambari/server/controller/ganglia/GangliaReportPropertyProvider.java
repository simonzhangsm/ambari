...
/**
 * Property provider implementation for a Ganglia source. This provider is specialized to pull metrics from existing Ganglia reports.
 */
public class GangliaReportPropertyProvider extends AbstractPropertyProvider {
	...
	protected final static Logger LOG = LoggerFactory.getLogger(GangliaReportPropertyProvider.class);
	...
	protected String getSpec(String clusterName, String report) throws SystemException {
		...
		sb.append(hostProvider.getGangliaCollectorHostName(clusterName)).append("/ganglia/graph.php?g=").append(report).append("&json=1");
