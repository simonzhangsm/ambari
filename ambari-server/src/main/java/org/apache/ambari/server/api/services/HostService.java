...
public class HostService extends BaseService {
	...
	@Path("{hostName}")
	@Produces("text/plain")
	public Response getHost(@Context HttpHeaders headers, @Context UriInfo ui, @PathParam("hostName") String hostName) {
		
		return handleRequest(headers, null, ui, Request.Type.GET, createHostResource(m_clusterName, hostName, ui));
	}
	...
	public Response getHosts(@Context HttpHeaders headers, @Context UriInfo ui) {
		return handleRequest(headers, null, ui, Request.Type.GET, createHostResource(m_clusterName, null, ui));
	}
	
	/**
	 * Handles POST /clusters/{clusterID}/hosts Create hosts by specifying an array of hosts in the http body. This is used to create multiple hosts in a single request.
	 * 
	...
	public Response createHosts(String body, @Context HttpHeaders headers, @Context UriInfo ui) {
		...
		return handleRequest(headers, body, ui, Request.Type.POST, createHostResource(m_clusterName, null, ui));
	}
	...
	@Path("{hostName}")
	@Produces("text/plain")
	public Response createHost(String body, @Context HttpHeaders headers, @Context UriInfo ui, @PathParam("hostName") String hostName) {
		
		return handleRequest(headers, body, ui, Request.Type.POST, createHostResource(m_clusterName, hostName, ui));
	}
	...
	@Path("{hostName}")
	@Produces("text/plain")
	public Response updateHost(String body, @Context HttpHeaders headers, @Context UriInfo ui, @PathParam("hostName") String hostName) {
		
		return handleRequest(headers, body, ui, Request.Type.PUT, createHostResource(m_clusterName, hostName, ui));
	}
	...
	public Response updateHosts(String body, @Context HttpHeaders headers, @Context UriInfo ui) {
		...
		return handleRequest(headers, body, ui, Request.Type.PUT, createHostResource(m_clusterName, null, ui));
	}
	...
	@Path("{hostName}")
	@Produces("text/plain")
	public Response deleteHost(@Context HttpHeaders headers, @Context UriInfo ui, @PathParam("hostName") String hostName) {
		
		return handleRequest(headers, null, ui, Request.Type.DELETE, createHostResource(m_clusterName, hostName, ui));
	}
