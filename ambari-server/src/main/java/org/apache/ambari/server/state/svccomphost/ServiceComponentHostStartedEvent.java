...
public class ServiceComponentHostStartedEvent extends ServiceComponentHostEvent {
	
	public ServiceComponentHostStartedEvent(String serviceComponentName, String hostName, long opTimestamp) {
		super(ServiceComponentHostEventType.HOST_SVCCOMP_STARTED, serviceComponentName, hostName, opTimestamp);
