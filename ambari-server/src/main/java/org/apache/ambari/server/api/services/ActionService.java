...
public class ActionService extends BaseService {
	...
	@Path("{actionName}")
	@Produces("text/plain")
	public Response getActionDefinition(@Context HttpHeaders headers, @Context UriInfo ui, @PathParam("actionName") String actionName) {
	...
	@Path("{actionName}")
	@Produces("text/plain")
	public Response createActionDefinition(String body, @Context HttpHeaders headers, @Context UriInfo ui, @PathParam("actionName") String actionName) {
	...
	@Path("{actionName}")
	@Produces("text/plain")
	public Response updateActionDefinition(String body, @Context HttpHeaders headers, @Context UriInfo ui, @PathParam("actionName") String actionName) {
	...
	@Path("{actionName}")
	@Produces("text/plain")
	public Response deleteActionDefinition(@Context HttpHeaders headers, @Context UriInfo ui, @PathParam("actionName") String actionName) {
	...
	ResourceInstance createActionDefinitionResource(String actionName) {
		return createResource(Resource.Type.Action, Collections.singletonMap(Resource.Type.Action, actionName));
	}
}
