...
public class ActionResponse {
	...
	public ActionResponse(String actionName, String actionType, String inputs, String targetService, String targetComponent, String description, String targetType, String defaultTimeout) {
	...
	public boolean equals(Object o) {
		...
		if (targetService != null ? !targetService.equals(that.targetService) : that.targetService != null) { return false; }
		
		if (targetComponent != null ? !targetComponent.equals(that.targetComponent) : that.targetComponent != null) { return false; }
		
		if (targetType != null ? !targetType.equals(that.targetType) : that.targetType != null) { return false; }
		
		if (defaultTimeout != null ? !defaultTimeout.equals(that.defaultTimeout) : that.defaultTimeout != null) { return false; }
