...
public interface Query {
	...
	/**
	 * Add a local (not sub-resource) property to the query. This is the select portion of the query.
	 * 
	 * @param property the property id which contains the group, property name and whether the property is temporal
	 */
	public void addLocalProperty(String property);
	
	/**
	 * Obtain the properties of the query. These are the properties that make up the select portion of the query for which values are to be retrieved.
	 * 
	...
	/**
	 * Return the predicate used to identify the associated resource. This includes the primary key and all parent id's;
	 * 
	...
	/**
	 * Set the user provided predicated on this query. This predicate will be "AND'd" with the internal query to produce the final predicate.
	 * 
	...
	/**
	 * Set the corresponding renderer. The renderer is responsible for the rendering of the query result, including which properties are contained and the format of the result.
	 * 
