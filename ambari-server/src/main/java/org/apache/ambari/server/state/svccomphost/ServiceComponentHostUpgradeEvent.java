...
public class ServiceComponentHostUpgradeEvent extends ServiceComponentHostEvent {
	
	public ServiceComponentHostUpgradeEvent(String serviceComponentName, String hostName, long opTimestamp, String stackId) {
		super(ServiceComponentHostEventType.HOST_SVCCOMP_UPGRADE, serviceComponentName, hostName, opTimestamp, stackId);
	}
}
