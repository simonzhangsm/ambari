...
/**
 * Processor which processes result objects prior to them being returned to the service. Processing can include adding additional data such as hrefs, or modifying/deleting existing data.
 */
