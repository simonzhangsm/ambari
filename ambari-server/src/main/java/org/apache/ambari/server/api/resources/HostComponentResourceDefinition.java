...
public class HostComponentResourceDefinition extends BaseResourceDefinition {
	...
	/**
	 * Host_Component resource processor which is responsible for generating href's for host components. This is called by the ResultPostProcessor during post processing of a result.
	 */
	...
	/**
	 * Host_Component resource processor which is responsible for generating a host section for host components. This is called by the ResultPostProcessor during post processing of a result.
	 */
