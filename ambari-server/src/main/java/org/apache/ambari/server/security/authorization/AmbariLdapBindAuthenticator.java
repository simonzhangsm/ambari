...
public class AmbariLdapBindAuthenticator extends BindAuthenticator {
	...
	public AmbariLdapBindAuthenticator(BaseLdapPathContextSource contextSource, Configuration configuration) {
		super(contextSource);
	...
	/**
	 * Checks weather user is a member of ambari administrators group in LDAP. If yes, sets user's ambari_admin attribute to true
	 * 
	 * @param user
	 * @return
	 */
