...
public class ResourceInstanceFactoryImpl implements ResourceInstanceFactory {
	 ...
	 */
	private final static Map<Resource.Type, ResourceDefinition> resourceDefinitions = new HashMap<Resource.Type, ResourceDefinition>();
	...
	public static ResourceDefinition getResourceDefinition(Resource.Type type, Map<Resource.Type, String> mapIds) {
		...
		if (resourceDefinitions.containsKey(type)) { return resourceDefinitions.get(type); }
