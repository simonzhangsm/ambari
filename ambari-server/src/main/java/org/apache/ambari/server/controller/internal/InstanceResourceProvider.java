...
public class InstanceResourceProvider extends AbstractDRResourceProvider {
	...
	private static Set<String> pkPropertyIds = new HashSet<String>(Arrays.asList(new String[] { INSTANCE_FEED_NAME_PROPERTY_ID, INSTANCE_ID_PROPERTY_ID }));
	 ...
	 */
	public InstanceResourceProvider(IvoryService ivoryService, Set<String> propertyIds, Map<Resource.Type, String> keyPropertyIds) {
	...
	protected static Instance getInstance(String feedName, String instanceId, Map<String, Object> propertyMap) {
		return new Instance(feedName, instanceId, (String) propertyMap.get(INSTANCE_STATUS_PROPERTY_ID), (String) propertyMap.get(INSTANCE_START_TIME_PROPERTY_ID), (String) propertyMap.get(INSTANCE_END_TIME_PROPERTY_ID), (String) propertyMap.get(INSTANCE_DETAILS_PROPERTY_ID),
