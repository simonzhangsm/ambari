...
public class ServiceComponentHostNotFoundException extends ObjectNotFoundException {
	
	public ServiceComponentHostNotFoundException(String clusterName, String serviceName, String serviceComponentName, String hostName) {
