...
public class HostComponentProcessResourceProvider extends ReadOnlyResourceProvider {
	...
	// Primary Key Fields
	private static Set<String> pkPropertyIds = new HashSet<String>(Arrays.asList(new String[] { HC_PROCESS_CLUSTER_NAME_ID, HC_PROCESS_HOST_NAME_ID, HC_PROCESS_COMPONENT_NAME_ID, HC_PROCESS_NAME_ID }));
	 ...
	 */
	HostComponentProcessResourceProvider(Set<String> propertyIds, Map<Resource.Type, String> keyPropertyIds, AmbariManagementController amc) {
	...
	private Set<HostComponentProcessResponse> getHostComponentProcesses(Set<Map<String, Object>> requestMaps) throws AmbariException {
