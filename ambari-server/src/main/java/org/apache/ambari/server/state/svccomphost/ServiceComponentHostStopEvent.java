...
public class ServiceComponentHostStopEvent extends ServiceComponentHostEvent {
	
	public ServiceComponentHostStopEvent(String serviceComponentName, String hostName, long opTimestamp) {
		super(ServiceComponentHostEventType.HOST_SVCCOMP_STOP, serviceComponentName, hostName, opTimestamp);
