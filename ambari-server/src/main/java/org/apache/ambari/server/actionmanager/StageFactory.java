...
public interface StageFactory {
	...
	Stage createNew(long requestId, @Assisted("logDir") String logDir, @Assisted("clusterName") String clusterName, @Assisted("requestContext") String requestContext, @Assisted("clusterHostInfo") String clusterHostInfo);
