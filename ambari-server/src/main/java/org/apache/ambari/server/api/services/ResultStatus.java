...
public class ResultStatus {
	...
	public static enum STATUS {
		OK(200, "OK", false), CREATED(201, "Created", false), ACCEPTED(202, "Accepted", false), CONFLICT(409, "Resource Conflict", true), NOT_FOUND(404, "Not Found", true), BAD_REQUEST(400, "Bad Request", true), UNAUTHORIZED(401, "Unauthorized", true), FORBIDDEN(403,
				"Forbidden", true), SERVER_ERROR(500, "Internal Server Error", true);
	...
	/**
	 * Obtain the result status. The result status contains a status code and a description of the status.
	 * 
	...
	/**
	 * Obtain the status code. This is a shortcut to obtaining the status code from the associated result status.
	 * 
	 * @return the status code
	 */
	...
	/**
	 * Determine whether the status is an error state. This is a shortcut to getting this information from the associated result status.
	 * 
	...
	/**
	 * Obtain the result message. This message is usually used when an exception occurred.
	 * 
