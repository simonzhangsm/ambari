...
public class StackInfo implements Comparable<StackInfo> {
	...
	/**
	 * Meaning: stores subpath from stack root to exact hooks folder for stack. These hooks are applied to all commands for services in current stack.
	 */
	...
	public boolean equals(Object obj) {
		if (!(obj instanceof StackInfo)) { return false; }
	...
	public StackVersionResponse convertToResponse() {
		...
		return new StackVersionResponse(getVersion(), getMinUpgradeVersion(), isActive(), getParentStackVersion());
	}
