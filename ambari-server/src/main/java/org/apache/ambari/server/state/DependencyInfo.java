...
public class DependencyInfo {
	/**
	 * The name of the component which is the dependency. Specified in the form serviceName/componentName.
	 */
	private String name;
	...
	/**
	 * Auto-deployment information for the dependency. If auto-deployment is enabled for the dependency, the dependency is automatically deployed if it is not specified in the provided topology.
	 */
	 ...
	 * 
	 * @param name the name of the component which is the dependency in the form serviceName/componentName
	 */
	public void setName(String name) {
		if (!name.contains("/")) { throw new IllegalArgumentException("Invalid dependency name specified in stack.  " + "Expected form is: serviceName/componentName"); }
		this.name = name;
	 ...
	 * 
	 * @return the name of the component which is the dependency in the form serviceName/componentName
	 */
