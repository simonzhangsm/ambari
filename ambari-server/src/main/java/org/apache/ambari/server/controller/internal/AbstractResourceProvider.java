...
public abstract class AbstractResourceProvider extends BaseProvider implements ResourceProvider, ObservableResourceProvider {
	...
	/**
	 * Get a set of properties from the given predicate. The returned set of property/value mappings is required to generate delete or get requests to the back end which does not deal with predicates. Note that the single predicate can result in multiple backend requests.
	 * 
	 * @param givenPredicate the predicate
	 * @return the set of properties used to build request objects
	 */
	protected Set<Map<String, Object>> getPropertyMaps(Predicate givenPredicate) throws UnsupportedPropertyException, SystemException, NoSuchResourceException, NoSuchParentResourceException {
	...
	/**
	 * Get a set of properties from the given property map and predicate. The returned set of property/value mappings is required to generate update requests to the back end which does not deal with Predicates. Note that the single property map & predicate can result in multiple
	 * backend requests.
	 * 
	...
	/**
	 * Invoke a command against the Ambari backend to create resources and map any {@link AmbariException} to the types appropriate for the {@link ResourceProvider} interface.
	 * 
	...
	/**
	 * Invoke a command against the Ambari backend to get resources and map any {@link AmbariException} to the types appropriate for the {@link ResourceProvider} interface.
	 * 
	 * @param command the command to invoke
	 * @param <T> the type of the response
	 * @return the response
	...
	/**
	 * Invoke a command against the Ambari backend to modify resources and map any {@link AmbariException} to the types appropriate for the {@link ResourceProvider} interface.
	 * 
	 * @param command the command to invoke
	 * @param <T> the type of the response
	 * @return the response
	 ...
	 * 
	 * @param parentCategory the parent category name. Checks for a property whose category is the parent and marked as a desired config.
