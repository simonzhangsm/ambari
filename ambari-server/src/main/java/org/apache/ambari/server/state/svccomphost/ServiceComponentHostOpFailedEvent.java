...
public class ServiceComponentHostOpFailedEvent extends ServiceComponentHostEvent {
	...
	public ServiceComponentHostOpFailedEvent(String serviceComponentName, String hostName, long opTimestamp) {
		super(ServiceComponentHostEventType.HOST_SVCCOMP_OP_FAILED, serviceComponentName, hostName, opTimestamp);
