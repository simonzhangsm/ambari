...
public class JobService extends BaseService {
	...
	@Path("{jobId}")
	@Produces("text/plain")
	public Response getJob(@Context HttpHeaders headers, @Context UriInfo ui, @PathParam("jobId") String jobId) {
		return handleRequest(headers, null, ui, Request.Type.GET, createJobResource(clusterName, workflowId, jobId));
	}
	...
	public Response getJobs(@Context HttpHeaders headers, @Context UriInfo ui) {
		return handleRequest(headers, null, ui, Request.Type.GET, createJobResource(clusterName, workflowId, null));
	}
	...
	public TaskAttemptService getTaskAttemptHandler(@PathParam("jobId") String jobId) {
