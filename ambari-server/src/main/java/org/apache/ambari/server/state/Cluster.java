...
public interface Cluster {
	...
	/**
	 * Gets all configs that match the specified type. Result is not the DESIRED configuration for a cluster.
	 * 
	...
	/**
	 * Gets the specific config that matches the specified type and tag. This not necessarily a DESIRED configuration that applies to a cluster.
	 * 
	 * @param configType the config type to find
	 * @param versionTag the config version to find
	 * @return a {@link Config} object, or <code>null</code> if the specific type and version have not been set.
	 */
	public Config getConfig(String configType, String versionTag);
	
	/**
	 * Sets a specific config. NOTE: This is not a DESIRED configuration that applies to a cluster.
	 * 
	...
	/**
	 * Adds and sets a DESIRED configuration to be applied to a cluster. There can be only one selected config per type.
	 * 
	 ...
	 * @return the {@link Config} instance, or <code>null</code> if the type has not been set.
	 */
