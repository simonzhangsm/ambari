...
public class TargetClusterService extends BaseService {
	...
	@Path("{targetName}")
	@Produces("text/plain")
	public Response getTargetCluster(@Context HttpHeaders headers, @Context UriInfo ui, @PathParam("targetName") String targetName) {
	...
	@Path("{targetName}")
	@Produces("text/plain")
	public Response createTargetCluster(String body, @Context HttpHeaders headers, @Context UriInfo ui, @PathParam("targetName") String targetName) {
	...
	@Path("{targetName}")
	@Produces("text/plain")
	public Response updateTargetCluster(String body, @Context HttpHeaders headers, @Context UriInfo ui, @PathParam("targetName") String targetName) {
	...
	@Path("{targetName}")
	@Produces("text/plain")
	public Response deleteTargetCluster(@Context HttpHeaders headers, @Context UriInfo ui, @PathParam("targetName") String targetName) {
	...
	ResourceInstance createTargetClusterResource(String targetName) {
		return createResource(Resource.Type.DRTargetCluster, Collections.singletonMap(Resource.Type.DRTargetCluster, targetName));
	}
}
