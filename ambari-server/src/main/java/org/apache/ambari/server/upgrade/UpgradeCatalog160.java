...
public class UpgradeCatalog160 extends AbstractUpgradeCatalog {
	...
	protected void executeDDLUpdates() throws AmbariException, SQLException {
		...
		DBAccessor.DBColumnInfo restartRequiredColumn = new DBAccessor.DBColumnInfo("restart_required", Boolean.class, 1, 0, false);
		...
		dbAccessor.addColumn("hostcomponentdesiredstate", new DBAccessor.DBColumnInfo("restart_required", Boolean.class, 1, 0, false));
	...
	protected void executeDMLUpdates() throws AmbariException, SQLException {
		...
		dbAccessor.executeQuery("INSERT INTO ambari_sequences(sequence_name, " + valueColumnName + ") " + "VALUES('viewentity_id_seq', 0)", true);
