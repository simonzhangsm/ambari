...
public class HostHealthyHeartbeatEvent extends HostEvent {
	...
	/**
	 * @return the heartbeatinfo, if present. Can return <code>null</code> if there was no new status.
	 */
	...
	/**
	 * @return the disks info, if present. Can return <code>null</code> if there was no new info.
	 */
