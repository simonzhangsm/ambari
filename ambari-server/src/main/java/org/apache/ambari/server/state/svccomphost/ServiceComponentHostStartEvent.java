...
public class ServiceComponentHostStartEvent extends ServiceComponentHostEvent {
	
	public ServiceComponentHostStartEvent(String serviceComponentName, String hostName, long opTimestamp) {
		super(ServiceComponentHostEventType.HOST_SVCCOMP_START, serviceComponentName, hostName, opTimestamp);
