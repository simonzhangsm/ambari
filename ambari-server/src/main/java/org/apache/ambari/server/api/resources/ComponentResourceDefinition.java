...
public class ComponentResourceDefinition extends BaseResourceDefinition {
	...
	/**
	 * Base resource processor which generates href's. This is called by the {@link org.apache.ambari.server.api.services.ResultPostProcessor} during post processing of a result.
	 */
