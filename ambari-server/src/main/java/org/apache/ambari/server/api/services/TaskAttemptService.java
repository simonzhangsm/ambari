...
public class TaskAttemptService extends BaseService {
	...
	@Path("{taskAttemptId}")
	@Produces("text/plain")
	public Response getTaskAttempt(@Context HttpHeaders headers, @Context UriInfo ui, @PathParam("taskAttemptId") String taskAttemptId) {
		return handleRequest(headers, null, ui, Request.Type.GET, createTaskAttemptResource(clusterName, workflowId, jobId, taskAttemptId));
	}
	...
	@GET
	@Produces("text/plain")
	public Response getTaskAttempts(@Context HttpHeaders headers, @Context UriInfo ui) {
		return handleRequest(headers, null, ui, Request.Type.GET, createTaskAttemptResource(clusterName, workflowId, jobId, null));
	}
