...
public class TargetClusterResourceProvider extends AbstractDRResourceProvider {
	...
	private static Set<String> pkPropertyIds = new HashSet<String>(Arrays.asList(new String[] { CLUSTER_NAME_PROPERTY_ID }));
	 ...
	 */
	public TargetClusterResourceProvider(IvoryService ivoryService, Set<String> propertyIds, Map<Resource.Type, String> keyPropertyIds) {
	...
	protected static Cluster getCluster(String clusterName, Map<String, Object> propertyMap) {
		...
		return new Cluster(clusterName, (String) propertyMap.get(CLUSTER_COLO_PROPERTY_ID), getInterfaces((Set<Map<String, Object>>) propertyMap.get(CLUSTER_INTERFACES_PROPERTY_ID)), getLocations((Set<Map<String, Object>>) propertyMap.get(CLUSTER_LOCATIONS_PROPERTY_ID)),
				properties);
	}
