...
/**
 * Represents service os-specific details (like repositories and packages). Represents <code>osSpecific</code>
 */
...
public class ServiceOsSpecific {
	...
	/**
	 * The <code>repo</code> tag. It has different set of fields compared to <link>org.apache.ambari.server.state.RepositoryInfo</link>, that's why we need another class
	 */
	@XmlAccessorType(XmlAccessType.FIELD)
