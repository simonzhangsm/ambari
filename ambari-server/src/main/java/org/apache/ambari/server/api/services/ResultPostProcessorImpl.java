...
public class ResultPostProcessorImpl implements ResultPostProcessor {
	...
	/**
	 * Map of resource post processors keyed by resource type. These are used to act on specific resource types contained in the result.
	 */
	...
	/**
	 * Registers the resource processors. Recursively registers child resource processors.
	 * 
