...
public class StackDependencyResourceProvider extends AbstractResourceProvider {
	...
	// Primary Key Fields
	private static Set<String> pkPropertyIds = new HashSet<String>(Arrays.asList(new String[] { SERVICE_NAME_ID, COMPONENT_NAME_ID }));
	 ...
	 */
	protected StackDependencyResourceProvider(Set<String> propertyIds, Map<Resource.Type, String> keyPropertyIds) {
	...
	public Set<Resource> getResources(Request request, Predicate predicate) throws SystemException, UnsupportedPropertyException, NoSuchResourceException, NoSuchParentResourceException {
		...
		for (Map<String, Object> properties : requestProps) {
			try {
				...
				if (requestProps.size() == 1) { throw e; }
