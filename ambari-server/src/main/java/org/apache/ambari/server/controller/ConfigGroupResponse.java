...
public class ConfigGroupResponse {
	...
	public ConfigGroupResponse(Long id, String clusterName, String groupName, String tag, String description, Set<Map<String, Object>> hosts, Set<Map<String, Object>> configVersions) {
		this.id = id;
