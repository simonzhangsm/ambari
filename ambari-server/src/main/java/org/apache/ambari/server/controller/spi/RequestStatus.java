...
/**
 * A RequestStatus represents the result of an asynchronous operation on resources. Methods are provided to check the status of the operation and to retrieve the set of resources involved in the operation.
 */
