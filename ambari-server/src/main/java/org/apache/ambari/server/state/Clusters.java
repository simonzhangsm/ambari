...
public interface Clusters {
	...
	/**
	 * Map host to the given cluster. A host can belong to multiple clusters
	 * 
	 * @param hostname
	 * @param clusterName
	 * @throws AmbariException
	 ...
	 * @throws AmbariException
	 */
	public void updateHostWithClusterAndAttributes(Map<String, Set<String>> hostsClusters, Map<String, Map<String, String>> hostAttributes) throws AmbariException;
