...
public class ViewContextImpl implements ViewContext {
	...
	protected static class ViewURLStreamProvider implements URLStreamProvider {
		...
		protected static ViewURLStreamProvider getProvider() {
			...
			org.apache.ambari.server.controller.internal.URLStreamProvider streamProvider = new org.apache.ambari.server.controller.internal.URLStreamProvider(DEFAULT_REQUEST_CONNECT_TIMEOUT, DEFAULT_REQUEST_READ_TIMEOUT, configuration.getTruststorePath(),
