...
public interface Expression<T> {
	 ...
	 * @param precedence the precedence level being merged. Only expressions at this precedence level should be merged. Others should simply return the left expression, themselves and the right expression in that order.
