...
/**
 * Module which allows for discovery of view resource providers. This module wraps another module and delegates to it for any resource types not defined in a view.
 */
public class ViewProviderModule implements ProviderModule {
	 ...
	 */
	private ViewProviderModule(ProviderModule providerModule, Map<Resource.Type, ResourceProvider> resourceProviders) {
	...
	public ResourceProvider getResourceProvider(Resource.Type type) {
		...
		if (resourceProviders.containsKey(type)) { return resourceProviders.get(type); }
