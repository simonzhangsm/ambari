...
public class HostRegistrationRequestEvent extends HostEvent {
	...
	public HostRegistrationRequestEvent(String hostName, AgentVersion agentVersion, long registrationTime, HostInfo hostInfo, AgentEnv env) {
		this(hostName, hostName, agentVersion, registrationTime, hostInfo, env);
	}
	
	public HostRegistrationRequestEvent(String hostName, String publicName, AgentVersion agentVersion, long registrationTime, HostInfo hostInfo, AgentEnv env) {
