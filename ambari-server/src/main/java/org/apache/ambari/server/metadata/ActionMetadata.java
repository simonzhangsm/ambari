...
public class ActionMetadata {
	...
	private void fillServiceCheckActions() {
		...
		serviceCheckActions.put("mapreduce", Role.MAPREDUCE_SERVICE_CHECK.toString());
		serviceCheckActions.put("mapreduce2", Role.MAPREDUCE2_SERVICE_CHECK.toString());
		serviceCheckActions.put("yarn", Role.YARN_SERVICE_CHECK.toString());
		serviceCheckActions.put("zookeeper", Role.ZOOKEEPER_QUORUM_SERVICE_CHECK.toString());
		...
		serviceCheckActions.put("webhcat", Role.WEBHCAT_SERVICE_CHECK.toString());
		serviceCheckActions.put("storm", Role.STORM_SERVICE_CHECK.toString());
		serviceCheckActions.put("falcon", Role.FALCON_SERVICE_CHECK.toString());
		serviceCheckActions.put("flume", Role.FLUME_SERVICE_CHECK.toString());
	}
	...
	public boolean isDefaultHostComponentCommand(String command) {
		if (command != null && defaultHostComponentCommands.contains(command)) { return true; }
		return false;
	}
}
