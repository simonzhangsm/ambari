...
public class RootServiceHostComponentResourceProvider extends ReadOnlyResourceProvider {
	...
	public static final String SERVICE_NAME_PROPERTY_ID = PropertyHelper.getPropertyId("RootServiceHostComponents", "service_name");
	public static final String HOST_NAME_PROPERTY_ID = PropertyHelper.getPropertyId("RootServiceHostComponents", "host_name");
	public static final String COMPONENT_NAME_PROPERTY_ID = PropertyHelper.getPropertyId("RootServiceHostComponents", "component_name");
	public static final String COMPONENT_VERSION_PROPERTY_ID = PropertyHelper.getPropertyId("RootServiceHostComponents", "component_version");
	public static final String COMPONENT_STATE_PROPERTY_ID = PropertyHelper.getPropertyId("RootServiceHostComponents", "component_state");
	public static final String PROPERTIES_PROPERTY_ID = PropertyHelper.getPropertyId("RootServiceHostComponents", "properties");
	
	private Set<String> pkPropertyIds = new HashSet<String>(Arrays.asList(new String[] { SERVICE_NAME_PROPERTY_ID, HOST_NAME_PROPERTY_ID, COMPONENT_NAME_PROPERTY_ID }));
	
	public RootServiceHostComponentResourceProvider(Set<String> propertyIds, Map<Type, String> keyPropertyIds, AmbariManagementController managementController) {
	...
	protected Set<RootServiceHostComponentResponse> getRootServiceHostComponents(Set<RootServiceHostComponentRequest> requests) throws AmbariException {
