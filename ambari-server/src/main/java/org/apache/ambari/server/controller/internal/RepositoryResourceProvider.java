...
public class RepositoryResourceProvider extends AbstractControllerResourceProvider {
	...
	public static final String REPOSITORY_NAME_PROPERTY_ID = PropertyHelper.getPropertyId("Repositories", "repo_name");
	
	public static final String STACK_NAME_PROPERTY_ID = PropertyHelper.getPropertyId("Repositories", "stack_name");
	
	public static final String STACK_VERSION_PROPERTY_ID = PropertyHelper.getPropertyId("Repositories", "stack_version");
	
	public static final String OS_TYPE_PROPERTY_ID = PropertyHelper.getPropertyId("Repositories", "os_type");
	...
	public static final String REPO_ID_PROPERTY_ID = PropertyHelper.getPropertyId("Repositories", "repo_id");
	...
	private static Set<String> pkPropertyIds = new HashSet<String>(Arrays.asList(new String[] { STACK_NAME_PROPERTY_ID, STACK_VERSION_PROPERTY_ID, OS_TYPE_PROPERTY_ID, REPO_ID_PROPERTY_ID }));
	
	public RepositoryResourceProvider(Set<String> propertyIds, Map<Type, String> keyPropertyIds, AmbariManagementController managementController) {
	...
	public Set<Resource> getResources(Request request, Predicate predicate) throws SystemException, UnsupportedPropertyException, NoSuchResourceException, NoSuchParentResourceException {
		...
		for (RepositoryResponse response : responses) {
			...
			setResourceProperty(resource, REPOSITORY_NAME_PROPERTY_ID, response.getRepoName(), requestedIds);
			...
			setResourceProperty(resource, REPO_ID_PROPERTY_ID, response.getRepoId(), requestedIds);
	...
	private RepositoryRequest getRequest(Map<String, Object> properties) {
		RepositoryRequest rr = new RepositoryRequest((String) properties.get(STACK_NAME_PROPERTY_ID), (String) properties.get(STACK_VERSION_PROPERTY_ID), (String) properties.get(OS_TYPE_PROPERTY_ID), (String) properties.get(REPO_ID_PROPERTY_ID));
