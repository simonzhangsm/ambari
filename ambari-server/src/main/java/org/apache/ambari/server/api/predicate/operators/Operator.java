...
public interface Operator {
	 ...
	 */
	public enum TYPE {
		LESS, LESS_EQUAL, GREATER, GREATER_EQUAL, EQUAL, NOT_EQUAL, AND, OR, NOT, IN, IS_EMPTY
	}
	...
	/**
	 * Obtain the precedence of the operator. This value is calculated based on the operators base precedence and the context of the surrounding expressions. Higher precedence values have higher precedence.
	 * 
