...
public interface DBAccessor {
	 ...
	 * @throws SQLException
	 */
	void renameColumn(String tableName, String oldColumnName, DBColumnInfo columnInfo) throws SQLException;
	
	/**
	 * Alter column from existing table, only supports varchar extension <br/>
	 * Use following sequence for more complex stuff: <br/>
	 * <li/>{@link #addColumn(String, org.apache.ambari.server.orm.DBAccessor.DBColumnInfo)} <li/>{@link #updateTable(String, String, Object, String)} <li/>{@link #dropColumn(String, String)} <li/>
	 * {@link #renameColumn(String, String, org.apache.ambari.server.orm.DBAccessor.DBColumnInfo)}
	 * 
	 * @param tableName
	 * @param columnInfo
	 * @throws SQLException
	...
	public class DBColumnInfo {
		...
		public DBColumnInfo(String name, Class type, Integer length, Object defaultValue, boolean nullable) {
			this.name = name;
			this.type = type;
			this.length = length;
		...
		public enum DBColumnType {
			VARCHAR, CHAR, INT, LONG, BOOL, TIME, BLOB
		}
	}
