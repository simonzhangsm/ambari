...
public class RepositoryInfo {
	...
	public String toString() {
		return "[ repoInfo: " + ", osType=" + osType + ", repoId=" + repoId + ", baseUrl=" + baseUrl + ", repoName=" + repoName + ", mirrorsList=" + mirrorsList + " ]";
	}
	
	public RepositoryResponse convertToResponse() {
		return new RepositoryResponse(getBaseUrl(), getOsType(), getRepoId(), getRepoName(), getMirrorsList(), getDefaultBaseUrl(), getLatestBaseUrl());
	}
