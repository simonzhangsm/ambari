...
public class FeedService extends BaseService {
	...
	@Path("{feedName}")
	@Produces("text/plain")
	public Response getFeed(@Context HttpHeaders headers, @Context UriInfo ui, @PathParam("feedName") String feedName) {
	...
	@Path("{feedName}")
	@Produces("text/plain")
	public Response createFeed(String body, @Context HttpHeaders headers, @Context UriInfo ui, @PathParam("feedName") String feedName) {
	...
	@Path("{feedName}")
	@Produces("text/plain")
	public Response updateFeed(String body, @Context HttpHeaders headers, @Context UriInfo ui, @PathParam("feedName") String feedName) {
	...
	@Path("{feedName}")
	@Produces("text/plain")
	public Response deleteFeed(@Context HttpHeaders headers, @Context UriInfo ui, @PathParam("feedName") String feedName) {
	...
	ResourceInstance createFeedResource(String feedName) {
		return createResource(Resource.Type.DRFeed, Collections.singletonMap(Resource.Type.DRFeed, feedName));
	}
}
