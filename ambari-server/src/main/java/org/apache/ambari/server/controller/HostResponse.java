...
public class HostResponse {
	...
	public HostResponse(String hostname, String clusterName, String ipv4, String ipv6, int cpuCount, int phCpuCount, String osArch, String osType, String osInfo, long availableMemBytes, long totalMemBytes, List<DiskInfo> disksInfo, long lastHeartbeatTime,
			long lastRegistrationTime, String rackInfo, Map<String, String> hostAttributes, AgentVersion agentVersion, HostHealthStatus healthStatus, String hostState, String status) {
	...
	public HostResponse(String hostname) {
		this(hostname, "", "", "", 0, 0, "", "", "", 0, 0, new ArrayList<DiskInfo>(), 0, 0, "", new HashMap<String, String>(), null, null, null, null);
	}
