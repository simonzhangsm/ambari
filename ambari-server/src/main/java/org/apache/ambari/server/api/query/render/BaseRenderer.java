...
/**
 * Base renderer. Contains functionality which may be common across implementations.
 */
public abstract class BaseRenderer implements Renderer {
	...
	/**
	 * Copies a tree of QueryInfo to a tree of Set<String>. This is useful in {@link Renderer#finalizeProperties(TreeNode, boolean)} for converting the passed in tree of query info to the return type which is a set of property names.
	 * 
