...
public interface Schema {
	...
	/**
	 * Get the property id for the property that uniquely identifies the given resource type for the resource described by this schema. </p> For example, the resource 'HostComponent' is uniquely identified by its associated 'Cluster', 'Host' and 'Component' resources. Passing the
	 * 'Host' resource type to this method on a schema object of a 'HostComponent' resource will return the id of the property of the foreign key reference from the 'HostComponent' to the 'Host'.
	 * 
	...
	/**
	 * Get the set of resource types used in the key that uniquely identifies the resource type described by this schema. </p> For example, the resource 'HostComponent' is uniquely identified by its associated 'Cluster', 'Host' and 'Component' resources. Calling this method
	 * should return a set of those resource types.
	 * 
	 * @return the set of resource types used in the key that uniquely identifies the resource type described by this schema.
	 */
