...
/**
 * The cluster controller is the main access point for accessing resources from the backend sources. A cluster controller maintains a mapping of resource providers keyed by resource types.
 */
public interface ClusterController extends SchemaFactory {
	...
	/**
	 * Populate the given resources from the associated property providers. This method may filter the resources based on the predicate and return a subset of the given resources.
	 * 
	 ...
	 * @throws NoSuchParentResourceException a specified parent resource doesn't exist
	 */
	Iterable<Resource> getIterable(Resource.Type type, Set<Resource> providerResources, Request request, Predicate predicate) throws NoSuchParentResourceException, UnsupportedPropertyException, NoSuchResourceException, SystemException;
	 ...
	 * @throws NoSuchParentResourceException a specified parent resource doesn't exist
	 */
	PageResponse getPage(Resource.Type type, Set<Resource> providerResources, Request request, Predicate predicate, PageRequest pageRequest) throws UnsupportedPropertyException, SystemException, NoSuchResourceException, NoSuchParentResourceException;
	
	/**
	 * Get the {@link Schema schema} for the given resource type. The schema for a given resource type describes the properties and categories provided by that type of resource.
	 * 
	 * @param type the resource type
	 ...
	 * @throws UnsupportedPropertyException thrown if the request contains unsupported property ids
	 * @throws SystemException an internal exception occurred
	 ...
	 * @throws UnsupportedPropertyException thrown if the predicate contains unsupported property ids
	 * @throws SystemException an internal exception occurred
	 * @throws NoSuchResourceException no matching resource(s) found
	 * @throws NoSuchParentResourceException a specified parent resource doesn't exist
	 */
