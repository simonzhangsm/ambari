...
public class RegistrationResponse {
	...
	/**
	 * exitstatus is a code of error which was rised on server side. exitstatus = 0 (OK - Default) exitstatus = 1 (Registration failed because different version of agent and server)
	 */
	...
	public String toString() {
		return "RegistrationResponse{" + "response=" + response + ", responseId=" + responseId + ", statusCommands=" + statusCommands + '}';
	}
}
