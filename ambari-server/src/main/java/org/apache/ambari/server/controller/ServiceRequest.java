...
public class ServiceRequest {
	...
	public ServiceRequest(String clusterName, String serviceName, String desiredState) {
	...
	public String toString() {
		...
		sb.append("clusterName=" + clusterName + ", serviceName=" + serviceName + ", desiredState=" + desiredState);
		return sb.toString();
	}
}
