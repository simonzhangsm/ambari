...
public class AmbariLocalUserDetailsService implements UserDetailsService {
	...
	@Inject
	public AmbariLocalUserDetailsService(Injector injector, Configuration configuration, AuthorizationHelper authorizationHelper, UserDAO userDAO, RoleDAO roleDAO) {
