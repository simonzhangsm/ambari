...
public class RootServiceHostComponentResponse {
	...
	public RootServiceHostComponentResponse(String hostName, String componentName, String componentState, String componentVersion, Map<String, String> properties) {
	...
	public boolean equals(Object o) {
		...
		return !(hostName != null ? !hostName.equals(that.hostName) : that.hostName != null) && !(componentName != null ? !componentName.equals(that.componentName) : that.componentName != null)
				&& !(componentState != null ? !componentState.equals(that.componentState) : that.componentState != null) && !(componentVersion != null ? !componentVersion.equals(that.componentVersion) : that.componentVersion != null)
