...
public interface Request {
	...
	/**
	 * Obtain the resource definition which corresponds to the resource being operated on by the request. The resource definition provides information about the resource type;
	 * 
	...
	/**
	 * Obtain the query predicate that was built from the user provided predicate fields in the query string. If multiple predicates are supplied, then they will be combined using the appropriate logical grouping predicate such as 'AND'.
	 * 
