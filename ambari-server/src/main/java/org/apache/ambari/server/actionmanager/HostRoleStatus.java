...
public enum HostRoleStatus {
	...
	/**
	 * Indicates whether or not this is a completed state. Completed means that the associated task has stopped running because it has finished successfully or has failed.
	 * 
