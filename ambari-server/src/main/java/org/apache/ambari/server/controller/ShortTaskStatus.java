...
public class ShortTaskStatus {
	...
	public ShortTaskStatus(int taskId, long stageId, String hostName, String role, String command, String status, String customCommandName) {
		this.taskId = taskId;
	...
	public String toString() {
		...
		sb.append("ShortTaskStatusDump " + ", stageId=" + stageId + ", taskId=" + taskId + ", hostname=" + hostName + ", role=" + role + ", command=" + command + ", status=" + status);
		return sb.toString();
	}
