...
public class QueryInfo {
	...
	/**
	 * Requested properties for the query. These properties comprise the select portion of a query.
	 */
	...
	/**
	 * Obtain the properties associated with the query. These are the requested properties which comprise the select portion of the query.
	 * 
