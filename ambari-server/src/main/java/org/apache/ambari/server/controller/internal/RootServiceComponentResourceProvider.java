...
public class RootServiceComponentResourceProvider extends ReadOnlyResourceProvider {
	...
	public static final String SERVICE_NAME_PROPERTY_ID = PropertyHelper.getPropertyId("RootServiceComponents", "service_name");
	
	public static final String COMPONENT_NAME_PROPERTY_ID = PropertyHelper.getPropertyId("RootServiceComponents", "component_name");
	
	public static final String COMPONENT_VERSION_PROPERTY_ID = PropertyHelper.getPropertyId("RootServiceComponents", "component_version");
	
	public static final String PROPERTIES_PROPERTY_ID = PropertyHelper.getPropertyId("RootServiceComponents", "properties");
	
	public static final String PROPERTIES_SERVER_CLOCK = PropertyHelper.getPropertyId("RootServiceComponents", "server_clock");
	
	private Set<String> pkPropertyIds = new HashSet<String>(Arrays.asList(new String[] { SERVICE_NAME_PROPERTY_ID, COMPONENT_NAME_PROPERTY_ID }));
	
	protected RootServiceComponentResourceProvider(Set<String> propertyIds, Map<Type, String> keyPropertyIds, AmbariManagementController managementController) {
