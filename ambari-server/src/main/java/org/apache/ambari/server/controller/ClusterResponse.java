...
public class ClusterResponse {
	...
	public ClusterResponse(Long clusterId, String clusterName, Set<String> hostNames, String desiredStackVersion) {
		super();
	...
	public String toString() {
		...
		sb.append("{" + " clusterName=" + clusterName + ", clusterId=" + clusterId + ", desiredStackVersion=" + desiredStackVersion + ", hosts=[");
		if (hostNames != null) {
			int i = 0;
