...
/**
 * Predicate that checks if the associated property category is empty. If the associated property id references a Map property then treat the Map as a category.
 */
