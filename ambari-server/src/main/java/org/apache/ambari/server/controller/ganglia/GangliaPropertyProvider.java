...
public abstract class GangliaPropertyProvider extends AbstractPropertyProvider {
	...
	protected final static Logger LOG = LoggerFactory.getLogger(GangliaPropertyProvider.class);
	
	// ----- Constructors ------------------------------------------------------
	
	public GangliaPropertyProvider(Map<String, Map<String, PropertyInfo>> componentPropertyInfoMap, StreamProvider streamProvider, ComponentSSLConfiguration configuration, GangliaHostProvider hostProvider, String clusterNamePropertyId, String hostNamePropertyId,
	...
	public Set<Resource> populateResources(Set<Resource> resources, Request request, Predicate predicate) throws SystemException {
		...
		if (ids.isEmpty()) { return resources; }
	...
	/**
	 * Get the request objects containing all the information required to make single requests to the Ganglia rrd script. Requests are created per cluster name / temporal information but can span multiple resources and metrics.
	 * 
