...
public class ConfigGroupService extends BaseService {
	...
	@GET
	@Produces("text/plain")
	public Response getConfigGroups(@Context HttpHeaders headers, @Context UriInfo ui) {
		return handleRequest(headers, null, ui, Request.Type.GET, createConfigGroupResource(m_clusterName, null));
	}
	...
	@Path("{groupId}")
	@Produces("text/plain")
	public Response getConfigGroup(@Context HttpHeaders headers, @Context UriInfo ui, @PathParam("groupId") String groupId) {
		return handleRequest(headers, null, ui, Request.Type.GET, createConfigGroupResource(m_clusterName, groupId));
	}
	...
	public Response createConfigGroup(String body, @Context HttpHeaders headers, @Context UriInfo ui) {
		return handleRequest(headers, body, ui, Request.Type.POST, createConfigGroupResource(m_clusterName, null));
	}
	...
	@Path("{groupId}")
	@Produces("text/plain")
	public Response updateConfigGroup(String body, @Context HttpHeaders headers, @Context UriInfo ui, @PathParam("groupId") String groupId) {
		return handleRequest(headers, body, ui, Request.Type.PUT, createConfigGroupResource(m_clusterName, groupId));
	}
	...
	@Path("{groupId}")
	@Produces("text/plain")
	public Response deleteConfigGroup(@Context HttpHeaders headers, @Context UriInfo ui, @PathParam("groupId") String groupId) {
		return handleRequest(headers, null, ui, Request.Type.DELETE, createConfigGroupResource(m_clusterName, groupId));
	}
