...
public class RequestScheduleResponse {
	...
	public RequestScheduleResponse(Long id, String clusterName, String description, String status, String lastExecutionStatus, Batch batch, Schedule schedule, String createUser, String createTime, String updateUser, String updateTime) {
		this.id = id;
