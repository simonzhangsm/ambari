...
public class HeartbeatMonitor implements Runnable {
	...
	public HeartbeatMonitor(Clusters clusters, ActionQueue aq, ActionManager am, int threadWakeupInterval, Injector injector) {
		...
		this.ambariManagementController = injector.getInstance(AmbariManagementController.class);
	 ...
	 */
	private StatusCommand createStatusCommand(String hostname, Cluster cluster, ServiceComponentHost sch) throws AmbariException {
