...
public class ServiceComponentHostStoppedEvent extends ServiceComponentHostEvent {
	
	public ServiceComponentHostStoppedEvent(String serviceComponentName, String hostName, long opTimestamp) {
		super(ServiceComponentHostEventType.HOST_SVCCOMP_STOPPED, serviceComponentName, hostName, opTimestamp);
