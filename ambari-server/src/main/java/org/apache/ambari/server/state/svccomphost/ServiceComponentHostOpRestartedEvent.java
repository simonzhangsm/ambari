...
public class ServiceComponentHostOpRestartedEvent extends ServiceComponentHostEvent {
	...
	public ServiceComponentHostOpRestartedEvent(String serviceComponentName, String hostName, long opTimestamp) {
		super(ServiceComponentHostEventType.HOST_SVCCOMP_OP_RESTART, serviceComponentName, hostName, opTimestamp);
