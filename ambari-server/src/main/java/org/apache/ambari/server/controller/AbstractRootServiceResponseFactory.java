...
public abstract class AbstractRootServiceResponseFactory {
	 ...
	 * @throws AmbariException if the resources cannot be read
	 */
	public abstract Set<RootServiceHostComponentResponse> getRootServiceHostComponent(RootServiceHostComponentRequest request, Set<HostResponse> hosts) throws AmbariException;
}
