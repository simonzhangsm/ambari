...
public interface AmbariManagementController {
	 ...
	 */
	public void createHostComponents(Set<ServiceComponentHostRequest> requests) throws AmbariException;
	 ...
	 */
	public void createConfiguration(ConfigurationRequest request) throws AmbariException;
	 ...
	 * 
	 * @param requests the request objects which identify the host components to be returned
	 ...
	 * 
	 * @param requests request objects which define which cluster to update and the values to set
	 ...
	 * 
	 * @param requests the request object which defines which host component to update and the values to set
	 * @param requestProperties the request properties
	 * @param runSmokeTest indicates whether or not to run a smoke test
	 * @return a track action response
	 * @throws AmbariException thrown if the resource cannot be updated
	 */
	public RequestStatusResponse updateHostComponents(Set<ServiceComponentHostRequest> requests, Map<String, String> requestProperties, boolean runSmokeTest) throws AmbariException;
