...
public class CommandScriptDefinition {
	...
	/**
	 * Timeout is given in seconds. Default value of 0 is used if not overridden at xml file
	 */
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof CommandScriptDefinition)) { return false; }
	...
	@Override
	public int hashCode() {
		return new HashCodeBuilder(17, 31).append(script).append(scriptType).append(timeout).toHashCode();
	}
}
