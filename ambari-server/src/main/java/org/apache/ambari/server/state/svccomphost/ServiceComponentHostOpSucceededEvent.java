...
public class ServiceComponentHostOpSucceededEvent extends ServiceComponentHostEvent {
	
	public ServiceComponentHostOpSucceededEvent(String serviceComponentName, String hostName, long opTimestamp) {
		super(ServiceComponentHostEventType.HOST_SVCCOMP_OP_SUCCEEDED, serviceComponentName, hostName, opTimestamp);
