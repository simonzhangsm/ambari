...
/**
 * Persistence manager which is responsible for persisting a resource state to the back end. This includes create, update and delete operations.
 */
public interface PersistenceManager {
	 ...
	 */
	public RequestStatus create(ResourceInstance resource, RequestBody requestBody) throws UnsupportedPropertyException, ResourceAlreadyExistsException, NoSuchParentResourceException, SystemException;
