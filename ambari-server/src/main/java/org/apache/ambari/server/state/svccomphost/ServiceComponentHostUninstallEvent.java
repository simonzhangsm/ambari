...
public class ServiceComponentHostUninstallEvent extends ServiceComponentHostEvent {
	
	public ServiceComponentHostUninstallEvent(String serviceComponentName, String hostName, long opTimestamp) {
		super(ServiceComponentHostEventType.HOST_SVCCOMP_UNINSTALL, serviceComponentName, hostName, opTimestamp);
