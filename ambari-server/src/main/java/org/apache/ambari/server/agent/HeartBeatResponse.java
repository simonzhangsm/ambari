...
public class HeartBeatResponse {
	...
	public String toString() {
		return "HeartBeatResponse{" + "responseId=" + responseId + ", executionCommands=" + executionCommands + ", statusCommands=" + statusCommands + ", registrationCommand=" + registrationCommand + ", restartAgent=" + restartAgent + '}';
	}
}
