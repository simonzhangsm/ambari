...
public class ServiceComponentHostInstallEvent extends ServiceComponentHostEvent {
	
	public ServiceComponentHostInstallEvent(String serviceComponentName, String hostName, long opTimestamp, String stackId) {
		super(ServiceComponentHostEventType.HOST_SVCCOMP_INSTALL, serviceComponentName, hostName, opTimestamp, stackId);
	}
