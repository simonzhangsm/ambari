...
public class TaskService extends BaseService {
	...
	@Path("{taskId}")
	@Produces("text/plain")
	public Response getTask(@Context HttpHeaders headers, @Context UriInfo ui, @PathParam("taskId") String taskId) {
		
		return handleRequest(headers, null, ui, Request.Type.GET, createTaskResource(m_clusterName, m_requestId, taskId));
	}
	...
	public Response getComponents(@Context HttpHeaders headers, @Context UriInfo ui) {
		return handleRequest(headers, null, ui, Request.Type.GET, createTaskResource(m_clusterName, m_requestId, null));
	}
