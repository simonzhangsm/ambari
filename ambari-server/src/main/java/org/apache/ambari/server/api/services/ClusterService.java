...
public class ClusterService extends BaseService {
	...
	@Path("{clusterName}")
	@Produces("text/plain")
	public Response getCluster(@Context HttpHeaders headers, @Context UriInfo ui, @PathParam("clusterName") String clusterName) {
	...
	@Path("{clusterName}")
	@Produces("text/plain")
	public Response createCluster(String body, @Context HttpHeaders headers, @Context UriInfo ui, @PathParam("clusterName") String clusterName) {
	...
	@Path("{clusterName}")
	@Produces("text/plain")
	public Response updateCluster(String body, @Context HttpHeaders headers, @Context UriInfo ui, @PathParam("clusterName") String clusterName) {
	...
	@Path("{clusterName}")
	@Produces("text/plain")
	public Response deleteCluster(@Context HttpHeaders headers, @Context UriInfo ui, @PathParam("clusterName") String clusterName) {
	...
	/**
	 * Get the host component resource without specifying the parent host component. Allows accessing host component resources across hosts.
	 * 
	 * @param clusterName the cluster name
	...
	/**
	 * Get the component resource without specifying the parent service. Allows accessing component resources across services.
	 * 
	 * @param clusterName the cluster name
	 * @return the host component service with no parent set
	 */
	...
	public RequestScheduleService getRequestScheduleService(@PathParam("clusterName") String clusterName) {
