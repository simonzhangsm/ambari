...
/**
 * Abstract base class for all stacks related resource definitions. Because we cloned /stacks from /stacks2 and changed the endpoint names in stacks, this class is a temporary mechanism to deviate from the standard /stacks2 endpoint names.
 */
