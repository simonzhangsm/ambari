...
public class ActionRequest {
	...
	public ActionRequest(String actionName, String actionType, String inputs, String targetService, String targetComponent, String description, String targetType, String defaultTimeout) {
	...
	public String toString() {
		return (new StringBuilder()).append("actionName :" + actionName).append(", actionType :" + actionType).append(", inputs :" + inputs).append(", targetService :" + targetService).append(", targetComponent :" + targetComponent).append(", description :" + description)
				.append(", targetType :" + targetType).append(", defaultTimeout :" + defaultTimeout).toString();
	}
}
