...
/**
 * This class encapsulates a configuration update request. The configuration properties are grouped at service level. It is assumed that different components of a service don't overload same property name.
 */
public class ConfigurationResponse {
	...
	public ConfigurationResponse(String clusterName, String type, String versionTag, Map<String, String> configs) {
		super();
