...
public abstract class ServiceComponentHostEvent extends AbstractEvent<ServiceComponentHostEventType> {
	...
	@JsonCreator
	public static ServiceComponentHostEvent create(@JsonProperty("type") ServiceComponentHostEventType type, @JsonProperty("serviceComponentName") String serviceComponentName, @JsonProperty("hostName") String hostName, @JsonProperty("opTimestamp") long opTimestamp,
			@JsonProperty("configs") Map<String, String> configs, @JsonProperty("stackId") String stackId) {
		switch (type) {
