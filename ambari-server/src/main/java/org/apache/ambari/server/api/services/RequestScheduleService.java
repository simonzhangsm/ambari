...
public class RequestScheduleService extends BaseService {
	...
	@GET
	@Produces("text/plain")
	public Response getRequestSchedules(@Context HttpHeaders headers, @Context UriInfo ui) {
		return handleRequest(headers, null, ui, Request.Type.GET, createRequestSchedule(m_clusterName, null));
	}
	...
	@Produces("text/plain")
	public Response getRequestSchedule(@Context HttpHeaders headers, @Context UriInfo ui, @PathParam("requestScheduleId") String requestScheduleId) {
		return handleRequest(headers, null, ui, Request.Type.GET, createRequestSchedule(m_clusterName, requestScheduleId));
	}
	...
	public Response createRequestSchedule(String body, @Context HttpHeaders headers, @Context UriInfo ui) {
		return handleRequest(headers, body, ui, Request.Type.POST, createRequestSchedule(m_clusterName, null));
	}
	...
	@Path("{requestScheduleId}")
	@Produces("text/plain")
	public Response deleteRequestSchedule(@Context HttpHeaders headers, @Context UriInfo ui, @PathParam("requestScheduleId") String requestScheduleId) {
		return handleRequest(headers, null, ui, Request.Type.DELETE, createRequestSchedule(m_clusterName, requestScheduleId));
	}
