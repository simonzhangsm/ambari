...
public class ServiceComponentHostRequest {
	...
	public ServiceComponentHostRequest(String clusterName, String serviceName, String componentName, String hostname, String desiredState) {
		super();
	...
	public String toString() {
		...
		sb.append("{" + " clusterName=").append(clusterName).append(", serviceName=").append(serviceName).append(", componentName=").append(componentName).append(", hostname=").append(hostname).append(", desiredState=").append(desiredState).append(", desiredStackId=")
				.append(desiredStackId).append(", staleConfig=").append(staleConfig).append(", adminState=").append(adminState).append("}");
		return sb.toString();
	}
