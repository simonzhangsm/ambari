...
public class StackId implements Comparable<StackId> {
	...
	public String getStackId() {
		if (stackName.isEmpty() && stackVersion.isEmpty()) { return ""; }
	...
	public boolean equals(Object object) {
		if (!(object instanceof StackId)) { return false; }
	...
	public int compareTo(StackId other) {
		...
		if (other == null) { throw new RuntimeException("Cannot compare with a null value."); }
	...
	public static void parseStackIdHelper(StackId stackVersion, String stackId) {
		if (stackId.isEmpty()) {
		...
		if (pos == -1 || (stackId.length() <= (pos + 1))) { throw new RuntimeException("Could not parse invalid Stack Id" + ", stackId=" + stackId); }
