...
/**
 * Service responsible for handling REST requests for the /blueprints endpoint. This blueprint resource is a blueprint template meaning that it doesn't contain any cluster specific information. Updates are not permitted as blueprints are immutable.
 */
@Path("/blueprints/")
public class BlueprintService extends BaseService {
	...
	@Path("{blueprintName}")
	@Produces("text/plain")
	public Response getBlueprint(@Context HttpHeaders headers, @Context UriInfo ui, @PathParam("blueprintName") String blueprintName) {
	...
	@Path("{blueprintName}")
	@Produces("text/plain")
	public Response createBlueprint(String body, @Context HttpHeaders headers, @Context UriInfo ui, @PathParam("blueprintName") String blueprintName) {
	...
	@Path("{blueprintName}")
	@Produces("text/plain")
	public Response deleteBlueprint(@Context HttpHeaders headers, @Context UriInfo ui, @PathParam("blueprintName") String blueprintName) {
	...
	ResourceInstance createBlueprintResource(String blueprintName) {
		return createResource(Resource.Type.Blueprint, Collections.singletonMap(Resource.Type.Blueprint, blueprintName));
	}
}
