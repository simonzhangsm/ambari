...
public class ExecutionCommand extends AgentCommand {
	...
	public boolean equals(Object other) {
		if (!(other instanceof ExecutionCommand)) { return false; }
		ExecutionCommand o = (ExecutionCommand) other;
		return (this.commandId.equals(o.commandId) && this.hostname.equals(o.hostname) && this.role.equals(o.role) && this.roleCommand.equals(o.roleCommand));
	}
	...
	/**
	 * Contains key name strings. These strings are used inside maps incapsulated inside command.
	 */
