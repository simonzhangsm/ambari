...
/**
 * Any method or class marked with annotation treated as requiring Jpa session. Marking method with {@code @RequiresSession} will start session before method call and close after. If session already in progress it will be ignored.
 */
