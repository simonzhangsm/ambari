...
public class StackUpgradeUtil {
	...
	private String getStackIdString(String originalStackId, String stackName, String stackVersion) {
		if (stackVersion == null) {
			stackVersion = gson.fromJson(originalStackId, StackId.class).getStackVersion();
		}
		
		return String.format("{\"stackName\":\"%s\",\"stackVersion\":\"%s\"}", stackName, stackVersion);
	}
	 ...
	 * @throws Exception
	 */
	public void updateLocalRepo(String stackName, String stackVersion, String repoUrl, String repoUrlOs) throws Exception {
