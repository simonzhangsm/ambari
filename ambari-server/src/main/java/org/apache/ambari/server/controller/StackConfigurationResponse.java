...
public class StackConfigurationResponse {
	 ...
	 */
	public StackConfigurationResponse(String propertyName, String propertyValue, String propertyDescription, String type, Boolean isRequired, String propertyType) {
		setPropertyName(propertyName);
		setPropertyValue(propertyValue);
		setPropertyDescription(propertyDescription);
		setType(type);
