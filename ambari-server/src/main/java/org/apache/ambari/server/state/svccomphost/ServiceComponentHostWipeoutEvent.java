...
public class ServiceComponentHostWipeoutEvent extends ServiceComponentHostEvent {
	
	public ServiceComponentHostWipeoutEvent(String serviceComponentName, String hostName, long opTimestamp) {
		super(ServiceComponentHostEventType.HOST_SVCCOMP_WIPEOUT, serviceComponentName, hostName, opTimestamp);
