...
public class HostComponentDesiredStateDAO {
	...
	public List<HostComponentDesiredStateEntity> findAll() {
		TypedQuery<HostComponentDesiredStateEntity> query = entityManagerProvider.get().createQuery("SELECT hcd from HostComponentDesiredStateEntity hcd", HostComponentDesiredStateEntity.class);
		try {
