...
public class Feed {
	 ...
	 */
	public Feed(String name, String description, String status, String schedule, String sourceClusterName, String sourceClusterStart, String sourceClusterEnd, String sourceClusterLimit, String sourceClusterAction, String targetClusterName, String targetClusterStart,
			String targetClusterEnd, String targetClusterLimit, String targetClusterAction, Map<String, String> properties) {
		this.name = name;
	...
	public boolean equals(Object o) {
		...
		return !(description != null ? !description.equals(feed.description) : feed.description != null) && !(name != null ? !name.equals(feed.name) : feed.name != null) && !(schedule != null ? !schedule.equals(feed.schedule) : feed.schedule != null)
				&& !(sourceClusterName != null ? !sourceClusterName.equals(feed.sourceClusterName) : feed.sourceClusterName != null) && !(status != null ? !status.equals(feed.status) : feed.status != null)
