...
/**
 * Represents auto-deployment stack information. This element may be a child of the component and dependency elements.
 */
public class AutoDeployInfo {
	...
	/**
	 * Optional component name to co-locate with. Specified in the form serviceName/componentName.
	 */
