...
public class Schedule {
	...
	public boolean equals(Object o) {
		...
		if (daysOfMonth != null ? !daysOfMonth.equals(schedule.daysOfMonth) : schedule.daysOfMonth != null) return false;
		if (endTime != null ? !endTime.equals(schedule.endTime) : schedule.endTime != null) return false;
		if (hours != null ? !hours.equals(schedule.hours) : schedule.hours != null) return false;
		if (minutes != null ? !minutes.equals(schedule.minutes) : schedule.minutes != null) return false;
		if (month != null ? !month.equals(schedule.month) : schedule.month != null) return false;
	...
	public boolean isEmpty() {
		return (minutes == null || minutes.isEmpty()) && (hours == null || hours.isEmpty()) && (dayOfWeek == null || dayOfWeek.isEmpty()) && (daysOfMonth == null || daysOfMonth.isEmpty()) && (month == null || month.isEmpty()) && (year == null || year.isEmpty())
				&& (startTime == null || startTime.isEmpty()) && (endTime == null || endTime.isEmpty());
	}
	
	/**
	 * Return a cron expression from the schedule fields. Example: "0 0 12 * * ?"
	 * 
	 * @return
	 */
	@JsonIgnore
	...
	public String toString() {
		return "Schedule {" + "minutes='" + minutes + '\'' + ", hours='" + hours + '\'' + ", days_of_month='" + daysOfMonth + '\'' + ", month='" + month + '\'' + ", day_of_week='" + dayOfWeek + '\'' + ", year='" + year + '\'' + ", startTime='" + startTime + '\'' + ", endTime='"
				+ endTime + '\'' + '}';
	}
}
