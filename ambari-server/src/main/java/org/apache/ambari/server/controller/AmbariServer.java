...
public class AmbariServer {
	...
	public void run() throws Exception {
		...
		try {
			...
			factory.registerSingleton("internalTokenAuthenticationFilter", injector.getInstance(InternalTokenAuthenticationFilter.class));
			...
			if (configs.csrfProtectionEnabled()) {
				sh.setInitParameter("com.sun.jersey.spi.container.ContainerRequestFilters", "com.sun.jersey.api.container.filter.CsrfProtectionFilter");
				proxy.setInitParameter("com.sun.jersey.spi.container.ContainerRequestFilters", "com.sun.jersey.api.container.filter.CsrfProtectionFilter");
			}
			...
			if (osType == null || osType.isEmpty()) { throw new RuntimeException(Configuration.OS_VERSION_KEY + " is not " + " set in the ambari.properties file"); }
