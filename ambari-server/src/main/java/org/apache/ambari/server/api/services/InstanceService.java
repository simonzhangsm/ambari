...
public class InstanceService extends BaseService {
	...
	@Path("{instanceID}")
	@Produces("text/plain")
	public Response getInstance(@Context HttpHeaders headers, @Context UriInfo ui, @PathParam("instanceID") String instanceID) {
		
		return handleRequest(headers, null, ui, Request.Type.GET, createInstanceResource(m_feedName, instanceID, ui));
	}
	...
	public Response getInstances(@Context HttpHeaders headers, @Context UriInfo ui) {
		return handleRequest(headers, null, ui, Request.Type.GET, createInstanceResource(m_feedName, null, ui));
	}
	...
	@Path("{instanceID}")
	@Produces("text/plain")
	public Response createInstance(String body, @Context HttpHeaders headers, @Context UriInfo ui, @PathParam("instanceID") String instanceID) {
		
		return handleRequest(headers, body, ui, Request.Type.POST, createInstanceResource(m_feedName, instanceID, ui));
	}
	...
	@Path("{instanceID}")
	@Produces("text/plain")
	public Response updateInstance(String body, @Context HttpHeaders headers, @Context UriInfo ui, @PathParam("instanceID") String instanceID) {
		
		return handleRequest(headers, body, ui, Request.Type.PUT, createInstanceResource(m_feedName, instanceID, ui));
	}
	...
	@Path("{instanceID}")
	@Produces("text/plain")
	public Response deleteInstance(@Context HttpHeaders headers, @Context UriInfo ui, @PathParam("instanceID") String instanceID) {
		
		return handleRequest(headers, null, ui, Request.Type.DELETE, createInstanceResource(m_feedName, instanceID, ui));
	}
