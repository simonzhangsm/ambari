...
public class StackServiceComponentResourceProvider extends ReadOnlyResourceProvider {
	...
	protected static final String STACK_NAME_PROPERTY_ID = PropertyHelper.getPropertyId("StackServiceComponents", "stack_name");
	protected static final String STACK_VERSION_PROPERTY_ID = PropertyHelper.getPropertyId("StackServiceComponents", "stack_version");
	protected static final String SERVICE_NAME_PROPERTY_ID = PropertyHelper.getPropertyId("StackServiceComponents", "service_name");
	protected static final String COMPONENT_NAME_PROPERTY_ID = PropertyHelper.getPropertyId("StackServiceComponents", "component_name");
	protected static final String COMPONENT_CATEGORY_PROPERTY_ID = PropertyHelper.getPropertyId("StackServiceComponents", "component_category");
	protected static final String IS_CLIENT_PROPERTY_ID = PropertyHelper.getPropertyId("StackServiceComponents", "is_client");
	protected static final String IS_MASTER_PROPERTY_ID = PropertyHelper.getPropertyId("StackServiceComponents", "is_master");
	protected static final String CARDINALITY_ID = PropertyHelper.getPropertyId("StackServiceComponents", "cardinality");
	...
	private static Set<String> pkPropertyIds = new HashSet<String>(Arrays.asList(new String[] { STACK_NAME_PROPERTY_ID, STACK_VERSION_PROPERTY_ID, SERVICE_NAME_PROPERTY_ID, COMPONENT_NAME_PROPERTY_ID }));
	
	protected StackServiceComponentResourceProvider(Set<String> propertyIds, Map<Type, String> keyPropertyIds, AmbariManagementController managementController) {
	...
	private StackServiceComponentRequest getRequest(Map<String, Object> properties) {
		return new StackServiceComponentRequest((String) properties.get(STACK_NAME_PROPERTY_ID), (String) properties.get(STACK_VERSION_PROPERTY_ID), (String) properties.get(SERVICE_NAME_PROPERTY_ID), (String) properties.get(COMPONENT_NAME_PROPERTY_ID));
	}
