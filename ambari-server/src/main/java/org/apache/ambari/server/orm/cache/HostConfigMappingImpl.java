...
public class HostConfigMappingImpl implements HostConfigMapping {
	...
	public void setClusterId(Long clusterId) {
		if (clusterId == null) throw new RuntimeException("ClusterId couldn't be null");
	...
	public void setHostName(String hostName) {
		if (hostName == null) throw new RuntimeException("HostName couldn't be null");
	...
	public void setType(String type) {
		if (type == null) throw new RuntimeException("Type couldn't be null");
		this.type = type;
	}
	...
	public void setCreateTimestamp(Long createTimestamp) {
		if (createTimestamp == null) throw new RuntimeException("CreateTimestamp couldn't be null");
	...
	public void setVersion(String version) {
		if (version == null) throw new RuntimeException("Version couldn't be null");
	...
	public void setUser(String user) {
		if (user == null) throw new RuntimeException("User couldn't be null");
		this.user = user;
	}
	...
	public void setSelected(Integer selected) {
		if (selected == null) throw new RuntimeException("Selected couldn't be null");
