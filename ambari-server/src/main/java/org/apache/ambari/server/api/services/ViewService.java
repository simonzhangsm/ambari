...
public class ViewService extends BaseService {
	...
	@Path("{viewName}")
	@Produces("text/plain")
	public Response getView(@Context HttpHeaders headers, @Context UriInfo ui, @PathParam("viewName") String viewName) {
	...
	@Path("{viewName}")
	@Produces("text/plain")
	public Response createView(String body, @Context HttpHeaders headers, @Context UriInfo ui, @PathParam("viewName") String viewName) {
	...
	@Path("{viewName}")
	@Produces("text/plain")
	public Response updateView(String body, @Context HttpHeaders headers, @Context UriInfo ui, @PathParam("viewName") String viewName) {
	...
	@Path("{viewName}")
	@Produces("text/plain")
	public Response deleteView(@Context HttpHeaders headers, @Context UriInfo ui, @PathParam("viewName") String viewName) {
	...
	private ResourceInstance createViewResource(String viewName) {
		return createResource(Resource.Type.View, Collections.singletonMap(Resource.Type.View, viewName));
	}
}
