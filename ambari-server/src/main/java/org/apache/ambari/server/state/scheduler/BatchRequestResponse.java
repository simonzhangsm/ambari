...
/**
 * Captures the response of a batch request. Provides functionality to capture the status of @Request status and @Task status in order to allow tolerance calculations
 */
