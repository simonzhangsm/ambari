...
public class ClusterControllerHelper {
	...
	private static String PROVIDER_MODULE_CLASS = System.getProperty("provider.module.class", "org.apache.ambari.server.controller.internal.DefaultProviderModule");
