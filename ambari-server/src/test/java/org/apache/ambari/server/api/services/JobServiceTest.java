...
public class JobServiceTest extends BaseServiceTest {
	...
	public List<ServiceTestInvocation> getTestInvocations() throws Exception {
		...
		Method m = service.getClass().getMethod("getJob", HttpHeaders.class, UriInfo.class, String.class);
		Object[] args = new Object[] { getHttpHeaders(), getUriInfo(), "jobId" };
		listInvocations.add(new ServiceTestInvocation(Request.Type.GET, service, m, args, null));
		
		// getJobs
		service = new TestJobService("clusterName", null);
		m = service.getClass().getMethod("getJobs", HttpHeaders.class, UriInfo.class);
