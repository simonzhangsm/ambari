...
public class WorkflowServiceTest extends BaseServiceTest {
	...
	public List<ServiceTestInvocation> getTestInvocations() throws Exception {
		...
		Method m = service.getClass().getMethod("getWorkflow", HttpHeaders.class, UriInfo.class, String.class);
		Object[] args = new Object[] { getHttpHeaders(), getUriInfo(), "jobId" };
		listInvocations.add(new ServiceTestInvocation(Request.Type.GET, service, m, args, null));
		
		// getWorkflows
		service = new TestWorkflowService("clusterName");
		m = service.getClass().getMethod("getWorkflows", HttpHeaders.class, UriInfo.class);
