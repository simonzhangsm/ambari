...
public class BaseResourceDefinitionTest {
	...
	public void testGetPostProcessors() {
		...
		ResourceProvider serviceResourceProvider = new ServiceResourceProvider(PropertyHelper.getPropertyIds(Resource.Type.Service), PropertyHelper.getKeyPropertyIds(Resource.Type.Service), managementController);
