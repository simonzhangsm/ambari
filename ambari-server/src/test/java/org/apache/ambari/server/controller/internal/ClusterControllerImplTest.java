...
public class ClusterControllerImplTest {
	...
	private static class TestResourceProvider extends AbstractResourceProvider {
		...
		protected Set<Resource> getResources(Resource.Type type, Predicate predicate, String keyPropertyId, Set<String> keyPropertyValues) throws SystemException, UnsupportedPropertyException, NoSuchParentResourceException, NoSuchResourceException {
