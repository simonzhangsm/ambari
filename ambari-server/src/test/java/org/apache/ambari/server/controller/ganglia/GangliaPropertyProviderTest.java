...
public class GangliaPropertyProviderTest {
	...
	public void testPopulateResources_checkHostComponent() throws Exception {
		...
		GangliaPropertyProvider propertyProvider = new GangliaHostComponentPropertyProvider(PropertyHelper.getGangliaPropertyIds(Resource.Type.HostComponent), streamProvider, configuration, hostProvider, CLUSTER_NAME_PROPERTY_ID, HOST_NAME_PROPERTY_ID, COMPONENT_NAME_PROPERTY_ID);
	...
	public void testPopulateResources_paramsAll() throws Exception {
		...
		String expected = (configuration.isGangliaSSL() ? "https" : "http") + "://domU-12-31-39-0E-34-E1.compute-1.internal/cgi-bin/rrd.py?c=HDPFlumeServer%2CHDPSlaves&h=ip-10-39-113-33.ec2.internal&m=";
	...
	private String getMetricsRegexes(List<String> metricsRegexes, Map<String, Map<String, PropertyInfo>> gangliaPropertyIds, String componentName) {
