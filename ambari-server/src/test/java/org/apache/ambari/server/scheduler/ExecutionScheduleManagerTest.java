...
public class ExecutionScheduleManagerTest {
	...
	@Transactional
	private RequestExecution createRequestExecution(boolean addSchedule) throws Exception {
	...
	public void testExecuteBatchRequest() throws Exception {
		...
		replay(clusterMock, clustersMock, configurationMock, requestExecutionMock, executionSchedulerMock, tokenStorageMock, batchRequestMock, scheduleManager, actionDBAccessorMock);
	...
	public void testGetBatchRequestResponse() throws Exception {
		...
		replay(clusterMock, clustersMock, configurationMock, executionSchedulerMock, tokenStorageMock, scheduleManager);
	...
	public void testFinalizeBatch() throws Exception {
		...
		replay(clustersMock, clusterMock, configurationMock, requestExecutionMock, executionSchedulerMock, scheduleManager, batchMock, batchRequestMock, triggerMock, jobDetailMock, actionDBAccessorMock);
