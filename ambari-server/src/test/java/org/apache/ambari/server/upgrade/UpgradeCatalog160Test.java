...
public class UpgradeCatalog160Test {
	...
	public void testExecuteDMLUpdates() throws Exception {
		...
		upgradeCatalog.updateConfigurationProperties("global", Collections.singletonMap("jobhistory_heapsize", "900"), false);
		expectLastCall();
	...
	private void setBPHostGroupConfigExpectations(DBAccessor dbAccessor, Capture<List<DBAccessor.DBColumnInfo>> columnCapture, Capture<DBAccessor.DBColumnInfo> restartRequiredColumnCapture) throws SQLException {
	...
	private void setViewEntityConfigExpectations(DBAccessor dbAccessor, Capture<List<DBAccessor.DBColumnInfo>> columnCapture) throws SQLException {
	...
	private void assertRestartRequiredColumn(Capture<DBAccessor.DBColumnInfo> restartRequiredColumnCapture) {
