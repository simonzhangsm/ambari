...
public class MasterKeyServiceTest extends TestCase {
	...
	private static final Log LOG = LogFactory.getLog(MasterKeyServiceTest.class);
	...
	public void testInitiliazeMasterKey() throws Exception {
		...
		MasterKeyService ms1 = new MasterKeyServiceImpl(fileDir + File.separator + "master", true);
