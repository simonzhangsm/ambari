...
public class JobTest {
	...
	private Action getRunningJob(long id, String jobName, long startTime) throws Exception {
		Action job = createNewJob(id, jobName, startTime);
		verifyProgressUpdate(job, ++startTime);
		return job;
	}
	
	private Action getCompletedJob(long id, String jobName, long startTime, boolean failedJob) throws Exception {
	...
	private void verifyProgressUpdate(Action job, long updateTime) throws Exception {
	...
	private void completeJob(Action job, boolean failJob, long endTime) throws Exception {
		ActionEvent e = null;
