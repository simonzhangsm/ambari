...
public class WorkflowResourceProviderTest {
	...
	private static Resource createWorkflowResponse(String clusterName, String workflowId) {
		Resource r = new ResourceImpl(Resource.Type.Workflow);
		r.setProperty(WorkflowResourceProvider.WORKFLOW_CLUSTER_NAME_PROPERTY_ID, clusterName);
	...
	private static class TestWorkflowResourceProvider extends WorkflowResourceProvider {
		protected TestWorkflowResourceProvider(Set<String> propertyIds, Map<Type, String> keyPropertyIds) {
