...
public class ConfigurationTest {
	...
	public void testNoNewlineInPassword() throws Exception {
		...
		ambariProperties.setProperty(Configuration.SERVER_JDBC_USER_PASSWD_KEY, passwordFile);
		
		Configuration conf = new Configuration(ambariProperties);
		MemberModifier.stub(MemberMatcher.method(Configuration.class, "readPasswordFromStore")).toReturn(null);
