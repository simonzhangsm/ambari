...
public class JobResourceProviderTest {
	...
	private static Resource createJobResponse(String clusterName, String workflowId, String jobId) {
	...
	private static class TestJobResourceProvider extends JobResourceProvider {
		protected TestJobResourceProvider(Set<String> propertyIds, Map<Type, String> keyPropertyIds, int type) {
