...
public class StackDependencyResourceProviderTest {
	...
	private StackDependencyResourceProvider createProvider() {
		return new StackDependencyResourceProvider(PropertyHelper.getPropertyIds(Resource.Type.StackServiceComponentDependency), PropertyHelper.getKeyPropertyIds(Resource.Type.StackServiceComponentDependency));
	}
}
