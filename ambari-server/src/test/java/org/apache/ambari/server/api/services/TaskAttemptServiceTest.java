...
public class TaskAttemptServiceTest extends BaseServiceTest {
	...
	public List<ServiceTestInvocation> getTestInvocations() throws Exception {
		...
		Method m = service.getClass().getMethod("getTaskAttempt", HttpHeaders.class, UriInfo.class, String.class);
		...
		m = service.getClass().getMethod("getTaskAttempts", HttpHeaders.class, UriInfo.class);
	...
	private class TestTaskAttemptService extends TaskAttemptService {
		...
		public TestTaskAttemptService(String clusterName, String workflowId, String jobId) {
