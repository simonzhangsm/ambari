...
public class TestHeartbeatHandler {
	...
	public void testCommandReport() throws AmbariException {
		...
		ActionManager am = new ActionManager(5000, 1200000, new ActionQueue(), clusters, db, new HostsMap((String) null), null, unitOfWork, injector.getInstance(RequestFactory.class), null);
	...
	private void populateActionDB(ActionDBAccessor db, String DummyHostname1) {
		...
		s.addHostRoleExecutionCommand(DummyHostname1, Role.HBASE_MASTER, RoleCommand.START, new ServiceComponentHostStartEvent(Role.HBASE_MASTER.toString(), DummyHostname1, System.currentTimeMillis()), DummyCluster, HBASE);
	...
	@Test
	public void testRegistration() throws AmbariException, InvalidStateTransitionException {
		ActionManager am = getMockActionManager();
		Clusters fsm = clusters;
	...
	@Test
	public void testRegistrationWithBadVersion() throws AmbariException, InvalidStateTransitionException {
	...
	@Test
	public void testInvalidOSRegistration() throws AmbariException, InvalidStateTransitionException {
		ActionManager am = getMockActionManager();
		Clusters fsm = clusters;
		HeartBeatHandler handler = new HeartBeatHandler(fsm, new ActionQueue(), am, injector);
		clusters.addHost(DummyHostname1);
	...
	@Test
	public void testIncompatibleAgentRegistration() throws AmbariException, InvalidStateTransitionException {
	...
	/**
	 * Tests the fact that when START and STOP commands are in progress, and heartbeat forces the host component state to STARTED or INSTALLED, there are no undesired side effects.
	 * 
	 * @throws AmbariException
	 * @throws InvalidStateTransitionException
	 */
	@Test
	public void testCommandReportOnHeartbeatUpdatedState() throws AmbariException, InvalidStateTransitionException {
		ActionManager am = getMockActionManager();
		Cluster cluster = getDummyCluster();
	...
	public void testComponentUpgradeFailReport() throws AmbariException, InvalidStateTransitionException {
		...
		assertEquals("Stack version of SCH should not change after fail report", stack122, serviceComponentHost1.getStackVersion());
	...
	@Test
	public void testComponents() throws AmbariException, InvalidStateTransitionException {
	...
	private ActionManager getMockActionManager() {
		return new ActionManager(0, 0, null, null, actionDBAccessor, new HostsMap((String) null), null, unitOfWork, injector.getInstance(RequestFactory.class), null);
	}
	
	private ComponentStatus createComponentStatus(String clusterName, String serviceName, String message, State state, String componentName, String stackVersion) {
		ComponentStatus componentStatus1 = new ComponentStatus();
	...
	private HeartBeatHandler getHeartBeatHandler(ActionManager am, ActionQueue aq) throws InvalidStateTransitionException, AmbariException {
	...
	private Cluster getDummyCluster() throws AmbariException {
		clusters.addHost(DummyHostname1);
