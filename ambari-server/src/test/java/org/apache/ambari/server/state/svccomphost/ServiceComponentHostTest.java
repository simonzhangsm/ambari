...
public class ServiceComponentHostTest {
	...
	private ServiceComponentHost createNewServiceComponentHost(String svc, String svcComponent, String hostName, boolean isClient) throws AmbariException {
		Cluster c = clusters.getCluster("C1");
		
		return createNewServiceComponentHost(c, svc, svcComponent, hostName);
	}
	
	private ServiceComponentHost createNewServiceComponentHost(Cluster c, String svc, String svcComponent, String hostName) throws AmbariException {
	...
	private ServiceComponentHostEvent createEvent(ServiceComponentHostImpl impl, long timestamp, ServiceComponentHostEventType eventType) throws AmbariException {
	...
	private void runStateChanges(ServiceComponentHostImpl impl, ServiceComponentHostEventType startEventType, State startState, State inProgressState, State failedState, State completedState) throws Exception {
		long timestamp = 0;
	...
	public void testGetAndSetConfigs() {
		...
		/*
		 * public Map<String, Config> getDesiredConfigs(); public void updateDesiredConfigs(Map<String, Config> configs); public Map<String, Config> getConfigs(); public void updateConfigs(Map<String, Config> configs);
		 */
	}
	...
	public void testActualConfigs() throws Exception {
		...
		final ConfigGroup configGroup = configGroupFactory.createNew(cluster, "cg1", "t1", "", new HashMap<String, Config>(), new HashMap<String, Host>());
