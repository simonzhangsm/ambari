...
public class ConfigGroupDAOTest {
	...
	private ConfigGroupEntity createConfigGroup(String clusterName, String groupName, String tag, String desc, List<HostEntity> hosts, List<ClusterConfigEntity> configs) throws Exception {
	...
	public void testFindByHost() throws Exception {
		...
		Set<ConfigGroupHostMapping> hostMappingEntities = configGroupHostMappingDAO.findByHost("h1");
