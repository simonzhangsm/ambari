...
public class QueryPostRequestTest extends BaseRequestTest {
	...
	@Override
	protected Request getTestRequest(HttpHeaders headers, RequestBody body, UriInfo uriInfo, final PredicateCompiler compiler, final RequestHandler handler, final ResultPostProcessor processor, ResourceInstance resource) {
