...
public class AmbariManagementControllerTest {
	...
	private static final String STACK_VERSION = "2.0.1";
	...
	private void createService(String clusterName, String serviceName, State desiredState) throws AmbariException {
	...
	private void createServiceComponent(String clusterName, String serviceName, String componentName, State desiredState) throws AmbariException {
		String dStateStr = null;
		if (desiredState != null) {
			dStateStr = desiredState.toString();
		}
	...
	private Long createConfigGroup(Cluster cluster, String name, String tag, List<String> hosts, List<Config> configs) throws AmbariException {
	...
	private long stopService(String clusterName, String serviceName, boolean runSmokeTests, boolean reconfigureClients) throws AmbariException {
	...
	private long stopServiceComponentHosts(String clusterName, String serviceName) throws AmbariException {
		...
		Map<String, String> mapRequestProps = new HashMap<String, String>();
		mapRequestProps.put("context", "Called from a test");
		RequestStatusResponse resp = controller.updateHostComponents(requests, mapRequestProps, false);
	...
	private long startService(String clusterName, String serviceName, boolean runSmokeTests, boolean reconfigureClients) throws AmbariException {
	...
	private long installService(String clusterName, String serviceName, boolean runSmokeTests, boolean reconfigureClients) throws AmbariException {
		ServiceRequest r = new ServiceRequest(clusterName, serviceName, State.INSTALLED.toString());
		Set<ServiceRequest> requests = new HashSet<ServiceRequest>();
		requests.add(r);
		Map<String, String> mapRequestProps = new HashMap<String, String>();
	...
	public void testCreateClusterWithHostMapping() throws AmbariException {
		...
		hostNames.add("h1");
		hostNames.add("h2");
		ClusterRequest r = new ClusterRequest(null, "c1", "HDP-2.0.1", hostNames);
	...
	public void testCreateServicesSimple() throws AmbariException {
		...
		clusters.getCluster("foo1").setDesiredStackVersion(new StackId("HDP-2.0.1"));
		...
		Assert.assertEquals("HDP-2.0.1", resp.getDesiredStackVersion());
	...
	public void testCreateServicesWithInvalidRequest() throws AmbariException {
		...
		clusters.getCluster("foo").setDesiredStackVersion(new StackId("HDP-2.0.1"));
		clusters.getCluster("bar").setDesiredStackVersion(new StackId("HDP-2.0.1"));
	...
	public void testCreateServiceWithInvalidInfo() throws AmbariException {
		...
		for (ServiceResponse svc : response) {
			...
			Assert.assertEquals("HDP-2.0.1", svc.getDesiredStackVersion());
	...
	@Test
	public void testCreateServiceComponentHostMultiple() throws AmbariException {
		String clusterName = "foo1";
		createCluster(clusterName);
		String serviceName = "HDFS";
		createService(clusterName, serviceName, null);
	...
	@Test
	public void testCreateServiceComponentHostWithInvalidRequest() throws AmbariException {
		// multiple clusters
		// dup objects
		// existing components
		// invalid request params
	...
	public void testGetClustersWithFilters() throws AmbariException {
		...
		c1.setDesiredStackVersion(new StackId("HDP-2.0.1"));
		c2.setDesiredStackVersion(new StackId("HDP-2.0.1"));
		c3.setDesiredStackVersion(new StackId("HDP-2.1.0"));
		...
		r = new ClusterRequest(null, null, "HDP-2.0.1", null);
		resp = controller.getClusters(Collections.singleton(r));
	...
	public void testGetServices() throws AmbariException {
		...
		c1.addService(s1);
		s1.setDesiredStackVersion(new StackId("HDP-2.0.1"));
		...
		Assert.assertEquals("HDP-2.0.1", s1.getDesiredStackVersion().getStackId());
	...
	public void testGetServiceComponents() throws AmbariException {
		...
		s1.addServiceComponent(sc1);
		sc1.persist();
		sc1.setDesiredStackVersion(new StackId("HDP-2.0.1"));
	...
	public void testGetServiceComponentHosts() throws AmbariException {
		Cluster c1 = setupClusterWithHosts("c1", "HDP-2.0.1", new ArrayList<String>() {
			{
				add("h1");
			}
		}, "centos5");
		...
		sch1.setDesiredStackVersion(new StackId("HDP-2.1.0"));
	...
	public void testHbaseDecommission() throws AmbariException {
		...
		ExecuteActionRequest request = new ExecuteActionRequest(clusterName, "DECOMMISSION", null, resourceFilters, null, params);
		...
		request = new ExecuteActionRequest(clusterName, "DECOMMISSION", null, resourceFilters, null, params);
	...
	private Cluster setupClusterWithHosts(String clusterName, String stackId, List<String> hosts, String osType) throws AmbariException {
	...
	public void testGetHosts() throws AmbariException {
		setupClusterWithHosts("c1", "HDP-2.0.1", new ArrayList<String>() {
			{
				add("h1");
				add("h2");
			}
		...
		setupClusterWithHosts("c2", "HDP-2.0.1", new ArrayList<String>() {
			{
				add("h3");
			}
		}, "centos5");
	...
	public void testServiceUpdateInvalidRequest() throws AmbariException {
		...
		clusters.getCluster(clusterName1).setDesiredStackVersion(new StackId("HDP-2.0.1"));
		clusters.getCluster(clusterName2).setDesiredStackVersion(new StackId("HDP-2.0.1"));
	...
	public void testServiceComponentHostUpdateRecursive() throws AmbariException {
		...
		reqs.add(req4);
		reqs.add(req5);
		RequestStatusResponse trackAction = controller.updateHostComponents(reqs, Collections.<String, String> emptyMap(), true);
		...
		reqs.add(req1);
		reqs.add(req2);
		trackAction = controller.updateHostComponents(reqs, Collections.<String, String> emptyMap(), true);
		Assert.assertNull(trackAction);
	}
	...
	public void testServiceComponentHostUpdateStackId() throws AmbariException {
		...
		StackId newStack = new StackId("HDP-2.1.0");
		StackId oldStack = new StackId("HDP-2.0.1");
		...
		reqs.clear();
		req1 = new ServiceComponentHostRequest(clusterName, serviceName1, componentName1, host1, State.INSTALLED.toString());
		req1.setDesiredStackId("HDP-2.0.1");
		reqs.add(req1);
		req2 = new ServiceComponentHostRequest(clusterName, serviceName1, componentName1, host2, State.INSTALLED.toString());
		req2.setDesiredStackId("HDP-2.0.1");
		reqs.add(req2);
		...
		reqs.add(req2);
		req3 = new ServiceComponentHostRequest(clusterName, serviceName1, componentName2, host1, State.INSTALLED.toString());
		req3.setDesiredStackId("HDP-2.0.1");
		reqs.add(req3);
		...
		for (Stage stage : stages) {
			for (HostRoleCommand command : stage.getOrderedHostRoleCommands()) {
				...
				Assert.assertTrue(execCommand.getCommandParams().containsKey("source_stack_version"));
				Assert.assertTrue(execCommand.getCommandParams().containsKey("target_stack_version"));
				Assert.assertEquals("{\"stackName\":\"HDP\",\"stackVersion\":\"2.0.1\"}", execCommand.getCommandParams().get("target_stack_version"));
				Assert.assertEquals(RoleCommand.UPGRADE, execCommand.getRoleCommand());
			}
		}
	}
	...
	public void testServiceComponentHostUpdateStackIdError() throws AmbariException {
		...
		c1.setCurrentStackVersion(new StackId("HDP-2.0.1"));
		reqs.clear();
		req1 = new ServiceComponentHostRequest(clusterName, serviceName1, componentName1, host1, State.STARTED.toString());
		...
		RequestStatusResponse resp = controller.updateHostComponents(reqs, Collections.<String, String> emptyMap(), true);
	...
	private void updateHostAndCompareExpectedFailure(Set<ServiceComponentHostRequest> reqs, String expectedMessage) {
		try {
			controller.updateHostComponents(reqs, Collections.<String, String> emptyMap(), true);
	...
	private void expectActionCreationErrorWithMessage(ExecuteActionRequest actionRequest, Map<String, String> requestProperties, String message) {
		try {
			RequestStatusResponse response = controller.createAction(actionRequest, requestProperties);
	...
	public void testRcaOnJobtrackerHost() throws AmbariException {
		...
		cr.setDesiredConfig(new ConfigurationRequest(clusterName, "global", "v1", configs));
	...
	@Test
	public void testReconfigureClientWithServiceStarted() throws AmbariException {
		String clusterName = "foo1";
		createCluster(clusterName);
		clusters.getCluster(clusterName).setDesiredStackVersion(new StackId("HDP-2.0.1"));
		String serviceName = "HDFS";
	...
	public void testReInstallClientComponent() throws AmbariException {
		...
		setReqs.add(schr);
		RequestStatusResponse resp = controller.updateHostComponents(setReqs, Collections.<String, String> emptyMap(), false);
	...
	public void testDecommissonDatanodeAction() throws AmbariException {
		...
		Assert.assertEquals("h2", cInfo.get("all_hosts").toArray()[Integer.parseInt(cInfo.get("decom_dn_hosts").iterator().next())]);
		Assert.assertEquals("DECOMMISSION", execCmd.getHostLevelParams().get("custom_command"));
	...
	public void testResourceFiltersWithCustomCommands() throws AmbariException {
		...
		ExecuteActionRequest request = new ExecuteActionRequest("c1", "RESTART", null, resourceFilters, null, params);
		...
		resourceFilters.add(resourceFilter);
		request = new ExecuteActionRequest("c1", Role.HDFS_SERVICE_CHECK.name(), null, resourceFilters, null, null);
		response = controller.createAction(request, requestProperties);
	...
	public void testHostLevelParamsSentWithCommands() throws AmbariException {
		...
		List<Stage> stages = actionDB.getAllStages(trackAction.getRequestId());
		Map<String, String> params = stages.get(0).getOrderedHostRoleCommands().get(0).getExecutionCommandWrapper().getExecutionCommand().getHostLevelParams();
	...
	public void testConfigGroupOverridesWithHostActions() throws AmbariException {
		...
		cr1 = new ConfigurationRequest(clusterName, "core-site", "version1", configs);
		cr2 = new ConfigurationRequest(clusterName, "hdfs-site", "version1", configs);
		cr3 = new ConfigurationRequest(clusterName, "mapred-site", "version1", configs);
	...
	public void testConfigGroupOverridesWithDecommissionDatanode() throws AmbariException {
		...
		Assert.assertTrue(cInfo.containsKey("decom_dn_hosts"));
		Assert.assertTrue(cInfo.get("decom_dn_hosts").size() == 1);
		Assert.assertEquals("h1", cInfo.get("all_hosts").toArray()[Integer.parseInt(cInfo.get("decom_dn_hosts").iterator().next())]);
		Assert.assertEquals("DECOMMISSION", execCmd.getHostLevelParams().get("custom_command"));
	}
	...
	public void testServerActionForUpgradeFinalization() throws AmbariException {
		String clusterName = "foo1";
		StackId currentStackId = new StackId("HDP-2.0.1");
		StackId newStackId = new StackId("HDP-2.0.1");
	...
	public void testUpdateClusterVersionBasic() throws AmbariException {
		...
		r = new ClusterRequest(c.getClusterId(), clusterName, "HDP-2.0.1", null);
		try {
			controller.updateClusters(Collections.singleton(r), mapRequestProps);
			fail("Update cluster should fail");
		} catch (AmbariException e) {
		...
		controller.updateClusters(Collections.singleton(r), mapRequestProps);
		StackId expectedStackId = new StackId("HDP-2.0.1");
	...
	public void testUpdateClusterVersionCombinations() throws AmbariException {
		...
		StackId currentStackId = new StackId("HDP-2.0.1");
		StackId desiredStackId = new StackId("HDP-2.0.1");
		...
		ClusterRequest r = new ClusterRequest(c.getClusterId(), clusterName, "HDP-2.0.1", null);
		...
		for (Stage stage : stages) {
			...
			for (HostRoleCommand command : stage.getOrderedHostRoleCommands()) {
				if (command.getRole() == Role.AMBARI_SERVER_ACTION) {
					...
					ExecutionCommand execCommand = command.getExecutionCommandWrapper().getExecutionCommand();
					Assert.assertTrue(execCommand.getCommandParams().containsKey(ServerAction.PayloadName.CURRENT_STACK_VERSION));
					Assert.assertTrue(execCommand.getCommandParams().containsKey(ServerAction.PayloadName.CLUSTER_NAME));
	...
	public void testServiceStopWhileStopping() throws AmbariException {
		...
		for (ServiceComponent sc : clusters.getCluster(clusterName).getService(serviceName).getServiceComponents().values()) {
			for (ServiceComponentHost sch : sc.getServiceComponentHosts().values()) {
				if (!sch.getServiceComponentName().equals("HDFS_CLIENT")) sch.setState(State.STARTED);
			}
		}
	...
	public void testGetTasksByRequestId() throws AmbariException {
		...
		stages.get(0).addHostRoleExecutionCommand(hostName1, Role.HBASE_MASTER, RoleCommand.START, new ServiceComponentHostStartEvent(Role.HBASE_MASTER.toString(), hostName1, System.currentTimeMillis()), clusterName, "HBASE");
		
		stages.add(new Stage(requestId1, "/a2", clusterName, context, CLUSTER_HOST_INFO));
		stages.get(1).setStageId(2);
		stages.get(1).addHostRoleExecutionCommand(hostName1, Role.HBASE_CLIENT, RoleCommand.START, new ServiceComponentHostStartEvent(Role.HBASE_CLIENT.toString(), hostName1, System.currentTimeMillis()), clusterName, "HBASE");
		
		stages.add(new Stage(requestId1, "/a3", clusterName, context, CLUSTER_HOST_INFO));
		stages.get(2).setStageId(3);
		stages.get(2).addHostRoleExecutionCommand(hostName1, Role.HBASE_CLIENT, RoleCommand.START, new ServiceComponentHostStartEvent(Role.HBASE_CLIENT.toString(), hostName1, System.currentTimeMillis()), clusterName, "HBASE");
		...
		stages.get(0).addHostRoleExecutionCommand(hostName1, Role.HBASE_CLIENT, RoleCommand.START, new ServiceComponentHostStartEvent(Role.HBASE_CLIENT.toString(), hostName1, System.currentTimeMillis()), clusterName, "HBASE");
	...
	public void testApplyConfigurationWithTheSameTag() {
		...
		try {
			...
			try {
				...
				ClusterRequest clusterRequest = new ClusterRequest(null, "c1", "HDP-2.0.1", null);
				...
				ConfigurationRequest configurationRequest = new ConfigurationRequest("c1", type, tag, gson.<Map<String, String>> fromJson("{ \"fs.default.name\" : \"localhost:8020\"}", confType));
	...
	public void testDisableAndDeleteStates() throws Exception {
		...
		try {
			...
			for (Map.Entry<String, ServiceComponentHost> entry : hostComponents.entrySet()) {
				ServiceComponentHost cHost = entry.getValue();
				cHost.handleEvent(new ServiceComponentHostInstallEvent(cHost.getServiceComponentName(), cHost.getHostName(), System.currentTimeMillis(), "HDP-2.0.1"));
				cHost.handleEvent(new ServiceComponentHostOpSucceededEvent(cHost.getServiceComponentName(), cHost.getHostName(), System.currentTimeMillis()));
			}
			...
			componentHost.handleEvent(new ServiceComponentHostInstallEvent(componentHost.getServiceComponentName(), componentHost.getHostName(), System.currentTimeMillis(), "HDP-2.0.1"));
	...
	/**
	 * Ensure that ServiceNotFoundException is handled where there are multiple requests as would be the case when an OR predicate is provided in the query.
	 */
	@Test
	...
	private void testRunSmokeTestFlag(Map<String, String> mapRequestProps, AmbariManagementController amc, Set<ServiceRequest> serviceRequests) throws AmbariException {
	...
	public void setMonitoringServicesRestartRequired() throws Exception {
		...
		createServiceComponent(clusterName, nagiosService, nagiosServer, State.INIT);
		...
		createServiceComponentHost(clusterName, nagiosService, nagiosServer, host1, null);
	...
	public void testMaintenanceState() throws Exception {
		...
		createServiceComponent(clusterName, serviceName, componentName2, State.INIT);
		createServiceComponent(clusterName, serviceName, componentName3, State.INIT);
		createServiceComponent(clusterName, nagiosService, componentName4, State.INIT);
		...
		Assert.assertNotNull(nagiosCmd.getExecutionCommandWrapper().getExecutionCommand().getPassiveInfo());
		Assert.assertEquals(Integer.valueOf(1), Integer.valueOf(nagiosCmd.getExecutionCommandWrapper().getExecutionCommand().getPassiveInfo().size()));
	...
	public void testEmptyConfigs() throws Exception {
		...
		cr.setDesiredConfig(new ConfigurationRequest(clusterName, "typeA", "v1", null));
		...
		cr.setDesiredConfig(new ConfigurationRequest(clusterName, "typeA", "v1", new HashMap<String, String>()));
		controller.updateClusters(Collections.singleton(cr), new HashMap<String, String>());
		...
		map.clear();
		map.put("c", "d");
		cr.setDesiredConfig(new ConfigurationRequest(clusterName, "typeA", "v3", map));
		controller.updateClusters(Collections.singleton(cr), new HashMap<String, String>());
		config = cluster.getDesiredConfigByType("typeA");
		Assert.assertNotNull(config);
