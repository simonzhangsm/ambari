...
public class UpgradeCatalogTest {
	...
	public void testUpdateConfigurationProperties() throws Exception {
		...
		testCatalog.updateConfigurationProperties("global", Collections.singletonMap("x", "y"), false);
		...
		// Override value
		testCatalog.updateConfigurationProperties("global", Collections.singletonMap("x", "z"), true);
		config = cluster.getDesiredConfigByType("global");
		Assert.assertNotNull(config);
